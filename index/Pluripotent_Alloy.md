...
_**"A liquid metal that can be applied to certain weapons to draw out inner strength. The discovery of the Pluripotent Alloys is said to have sparked the development of Ironsing during the Canticlysm."**_

## Description

Pluripotent Alloy is an item in Deepwoken that you can apply to midgame weapons. It upgrades its stats into that of an endgame weapon, like the [Shattered Katana](Shattered_Katana.md), [Rifle Spear](Rifle_Spear.md) and [Pale Morning](Pale_Morning.md).

This is still a fairly new mechanic in the game and is sure to be expanded upon.

## How to Obtain

### You can get Pluripotent Alloy through three methods:
...
-   Penetration: 0% -> 10%
-   Scaling: 5 -> 8
-   +New Critical attack (gives +30% extra chance to proc Knife's Journey)
