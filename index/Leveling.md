...
-   In truth, you start the game with 30 points upon character creation, but these are usually discounted in your [Attunement](Attunements.md) and initial attributes, lowering down to the usual 15. As such, if you're an experienced player and following a build's stat order it is highly recommended you tweak around these initial values to fit your desired build.

If you have the [Autodidact](Boons_and_Flaws.md#autodidact) Boon, you'll receive 3 Free Points to allocate when leveling. [Adrets](Adret.md) have this boon by default as a racial trait, and if you have both the you will instead get 6 Free Points upon every new level. Free Points allow you to increase any attributes of your choice without needing that attribute's EXP by clicking said on attribute. [Autodidact](Boons_and_Flaws.md#autodidact) and [Adret](Adret.md) points cannot be used after completing Power 20, and by then are completely useless. It is recommended to use your points as much as you can before reaching that milestone.
...
Keep in mind that you can get said Free Points even without [Autodidact](Boons_and_Flaws.md#autodidact) or the [Adret](Adret.md) Aspect by collecting white orbs that may rarely spawn out of enemies, or by striking a deal with the [Shrine of Courage](Shrine_of_Courage.md).
