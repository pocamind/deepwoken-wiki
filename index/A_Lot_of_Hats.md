...
categories: [Exclusive, Equipment, Head, Hats, Developer Spec]
notices:
...
-   This item description references the _[first installment](<https://en.wikipedia.org/wiki/Dark_Souls_(video_game)>)_ of the _[Dark Souls](https://en.wikipedia.org/wiki/Dark_Souls)_ franchise.
-   This item cannot be dropped by the user.
-   This item can however be stored in a bank.
