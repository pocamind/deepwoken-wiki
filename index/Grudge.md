...
-   A strategy that may lead to more spawns is having multiple people with uncapped Gale in a server.
-   Using [Rhythm](Murmur.md) to seek out event spawns is another strategy that seems to work.

-   Arch has confirmed that the only req is uncapped gale. \[1\]
