...
-   You can only have 2 Attunements per Character, 1 if you started with no attunements.
    -   After receiving three Attunements, you must receive the remaining Attunement items _(nightblood, skyblood, etc)_ from other players if you want more Attunements.
