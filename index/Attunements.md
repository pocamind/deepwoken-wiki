...
-   Arch\_Mage has said he wants to add both [Lightkeep](Lightkeep.md) and Divinity magic, however Lightkeep is not confirmed to be an attunement, but may rather be a general form of magic.
-   Arch\_Mage has said that he would like to add Earth as an attunement however does not yet know how to make it different from ice.
