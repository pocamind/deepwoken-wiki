...
By default, players are given _**3 Combat Mantra slots, 1 Mobility [Mantra slot](https://www.great-men.org/mantra303/), 1 Support Mantra slot and 1 Wildcard (freebie) Mantra slot.**_ Extra Mantras will be stored in the inventory with under the pink-colored [Mantra Modifiers](Mantra_Modifiers.md) category. These limitations can be softened via [Oaths](Oaths.md) and the Talents **Neuroplasticity** or **Will o' Wisp**, both of which will help expand your Mantra arsenal.
