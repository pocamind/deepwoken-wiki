...
| Weapon you can get a Motif from | What weapon class the Motif works on |
| --- | --- |
| 
...
Any [Flintlock](Weapons.md#flintlocks) with the default critical
...
Any [Rifle](Weapons.md#rifles) with the default critical
