...
Once the dialogue ends, the owl will not attack unless hit first or **if** **the player turns their back****.** Just like escaping from dangerous wildlife such as lions or bears in real life, if the player maintains eye contact with the owl and walks backward, it will not attack and will eventually give up once out of detection range.
...
-   Corrupted Deep Owls have a chance drop Void Feathers which are used as part of the _Visionshaper_ [Oath](Oaths.md).
