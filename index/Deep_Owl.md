...
-   There is a chance that a non-corrupted Deep Owl will drop Void Feather, but the drop rate is rather rare, which makes it possible to grind Void Feathers for [Visionshaper](Oaths.md) at the [The Lordsgrove](The_Lordsgrove.md), There is a Deep Owl that has a "Static Spawn" location which is, ironically, in-front of the [VIsionshaper](Oaths.md) statue.
