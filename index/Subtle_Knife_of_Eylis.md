...
A Knives of Eylis Captain is an NPC that can be found anywhere on the map escorting a Navaen Hostage and can be found in the following events:

-   Knives of Eylis raiding an Etrean ship ([The Aratel Sea](The_Aratel_Sea.md))

A Knives of Eylis Captain is also always accompanied with 2 [Knives of Eylis](Knife_of_Eylis.md)'.

A Knives of Eylis Captain's appearance consists of a [Whaler Coat](Whaler_Coat.md) outfit and an assortment of stolen accessories with their [race](Aspects.md) and gender varying.
...
A Knives of Eylis Captain executes it's opponent after knocking them:
