...
Upon talking to him, Korin will give the player a free lumber axe if the player does not already have one. He will then ask the player for 6 wood, which when handed to him, will increase the player's reputation with [Etrea](Etrea.md). This quest can be repeated as many times as the player wants.
