...
-   If you are low on HP you can run into the [Boundary](Boundary.md) in [The Polymarch](The_Polymarch.md) to regain some HP or you could wait out the [Combat Tag](Combat_Tag.md) to fully recover and try again, but Titus would of most likely have recovered himself.
-   It's possible to easily defeat Titus by luring him to a [whirlpool](Whirlpools.md). Titus will use Warp Kick, likely into the whirlpool's range, and thus be sucked in, instantly killing him. An easy way of doing this is being combat tagged by Titus and running into the [Boundary](Boundary.md) then going to [Meteor Isle](Meteor_Isle.md), then get close enough to [The Polymarch](The_Polymarch.md) that Titus will Warp Kick to you and slowly getting closer to the [whirlpool](Whirlpools.md).
