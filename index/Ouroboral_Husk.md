...
| type | Effigy |
| rarity | Relic |
| usage | Teleporting the player to Saramaed Hollow or Saramaed Summit. |
| bankable | No |
| droppable | No |
| pass down | No |
...
-   If used in the Overworld:
    1.  Garden Gate ([Saramaed Hollow](Saramaed_Hollow.md))
    2.  Skyward Vent ([Saramaed Summit](Saramaed_Summit.md))
-   If used in [Saramaed Hollow](Saramaed_Hollow.md):
    1.  Skyward Vent ([Saramaed Summit](Saramaed_Summit.md))
...
-   'Ouroboral' comes from the word Ouroboros, a snake that eats its own tail, it is a symbol that represents Cycles.
...
-   Ouroboral Husk cannot be used in the depths, showing a special text saying "you feel lurching sensation. Not here." if you try and do so.
