...
**Progress:** As with all bosses, the Ferryman grants [Resonance](Resonance.md) progress on defeat.
...
-   **[Legendary Rings](Equipment.md#rings)** - An assortment of Rings that grant various powerful buffs.
...
-   **[Idol of Yun'Shul](<Idol_of_Yun'Shul.md>)** - Ritual idol and [relic](Relics.md) that allows its user to redeem one wish from anywhere and without the need of a [Resonance](Resonance.md).
...
-   Due to this boss, The [Scion of Ethiron](Scion_of_Ethiron.md), and [Amorus Pleeksty](Amorus_Pleeksty.md) using pink variations of their element, they were thought to be using "awakened elements." However, despite the connections that would lead one to believe this is the application of the Song that Kaide talks about, Arch\_Mage confirmed that there is no relation, and that he only chose pink because "it looked cool".
