...
This Outfit also grants the [Serpent's Dance](Talents.md#equipment-talents) Talent, which gives the [Fang and Coil](Fang_and_Coil.md) fist style a new Running Critical Attack. This additional critical can **only** be used on fist weapons that do not have unique criticals ([Fists](Fists.md), [Iron](Iron_Cestus.md)/[Legion](Legion_Cestus.md)/[Flamekeeper Cestus](Flamekeeper_Cestus.md), and [Gaunts of Enmity](Gaunts_of_Enmity.md)).
