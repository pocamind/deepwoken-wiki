...
Hollow **Angels** are white and dull-yellow humanoid creatures with wings. They wield black recolors of the [Iron Spear](Iron_Spear.md) and use the [Crazy Slots](Crazy_Slots.md) spear ability. They are summoned by entities called Watchers. Many can be found in Celtor, the sunken city in the [First Layer](First_Layer.md) of [The Depths](The_Depths.md). Each will summon two Hollow Angels. A Watcher can additionally be found in the Temple of the Forgotten Flame in Erisia, and will only spawn a single Hollow Angel.
