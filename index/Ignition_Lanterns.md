...
These Lanterns are developed by [The Ignition Union](The_Ignition_Union.md) as a way to survive in the Second Layer. They are seen scattered around the area, with one of them in the [The Frontier Furnace](The_Frontier_Furnace.md). As mentioned by [Sunway](Sunway.md), these lanterns work by blasting the parasites with enough heat to shock them, forcing them to let go. All the while only dealing a minor sting to the user.

There is a different version of this lantern with white and blue coloring that is only present in the [Galewax](Galewax.md) area, where you would get [Enchant Stones](Enchant_Stone.md).
