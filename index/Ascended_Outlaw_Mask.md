...
| enchantable | No |
| pass down | Yes |
| obtainment | Crafting:, Prison Crafting Station + Western Outlaw Mask + 1x Ardour Manifestation + 5x Might Gem |
...
The [Destructive Yell](Talents.md#destructive-yell) Talent breaks campfires around the player when they use [Ardour](Murmur%253A_Ardour.md) Scream and also doubles its range.
