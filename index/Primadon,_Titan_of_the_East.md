...
Loud and enormous, the **Primadon** is a giant sea monkey [Boss](Bosses.md). It is an apelike creature, standing at roughly 68.9 feet (21 meters), with some features of marine life, featuring webbed feet and fins on its arms and head.
...
-   **Small chest -** Has 1-3 [Umbral Obsidian](Umbral_Obsidian.md) in it and a low chance of 1-2 Deep Gems or Legendary Rings, and can rarely include the [Stormseye](Stormseye.md), as well as various relics.
...
-   Primadon's respawn time is around 3 minutes.
    -   This cooldown is in effect for the player who summoned Primadon, and everyone involved (Dealt damage at least once, But a person who has not dealt damage to the Sea monkey will be able to spawn Primadon with no cooldown in the same server). The cooldown is for the account in use and is not a slot cooldown, for some weird reason. (Has been tested by me multiple times)
