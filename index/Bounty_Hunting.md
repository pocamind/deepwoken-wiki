...
-   ~The star rating represent the power of a player: more stars means the player is higher level.~ Stars actually correspond to just how low the reputation with a given faction is, with higher stars corresponding to lower rep. However, they can be used as a rule of thumb to determine power, as individuals who get particularly low reputation are often those who have been around and have gripped many players/npcs.
-   Players below Power 15 do not appear on the bounty board. A power range that is too large also prevents the target from being hunted.
