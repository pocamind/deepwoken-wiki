...
Lost Divers appear translucent as well as bearing the armor of a [Black Diver](Black_Diver.md) with their [race](Aspects.md) varying.
...
A Lost Diver executes it's opponent after knocking them:

| Name | Description |
| --- | --- |
| Execute | \[[Markor's Inheritor](<Markor's_Inheritor.md>)\] Pins down opponent while raising weapon before firmly bashing the opponent's face |
