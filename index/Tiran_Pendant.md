...
| enchantable | No |
| pass down | Yes |
| obtainment | Second Layer, Primadon's Gem Chest, The Diluvian Mechanism, Fishing |
...
Equipping it grants the talent "Featherfall" which grants Near-complete immunity to fall damage. After a certain amount of damage has been negated, the pendant will go on cooldown for 10 minutes.
...
-   Used to have a bug which relogging while the passive was on cooldown when double the cooldown leading to massive cooldowns on the passive.
