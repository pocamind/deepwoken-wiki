...
The Scoundrel's Bounty is a populated ship in what seems to be the middle of nowhere on the open sea, it does not function as a [boat](Ships_&_Sailing.md), and is an immovable location, similar to an island. This is where the events of the [Tutorial](Tutorial.md) take place.
