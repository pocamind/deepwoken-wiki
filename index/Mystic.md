...
Note that you could have only gotten prompts for Mantra types that you are eligible to obtain, and your Whisper Draw may not be exclusively that Mantra type.
...
-   If you lack the 20 Note fee, the Mystic would state: "No money, friend? How ever will I feed myself?"
-   When you are at a campfire, hovering over classes in your Talent list in-game shows you the Mystic prompt for it.
-   Mystics were almost exclusively [Chrysid](Chrysid.md). Seemingly due to their connection with spirituality and religion, however there is one non-Chrysid mystic, being the one in [Saramaed Hollow](Saramaed_Hollow.md) who is a [Vesperian](Vesperian.md). Strangely, this Mystic had the [Chrysid](Chrysid.md) antennae.
