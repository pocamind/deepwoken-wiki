...
Each family of Talents has a prompt for it. Note that you can only get prompts for Talent families that you are eligible to get a Talent card from and you may not get all the cards from a family. **Note that Rare Talents are NOT affected by Mystics at all, even if you use Shrine of Chance.**

Next to the Talent category's name, it will list a number. This number is the amount of non-rare Talents within that Talent category that you meet the requirements for. For example: if you have 25 Agility, "Alley Cat (1)" will be listed, as you only meet the requirements for Scaredy Cat.
...
-   _Assassin_ (Deep Wound, Lowstride, Lights Out, Unseen Threat)
-   _Butterfly_ (Swift Rebound, Ghost) **(Note; Cannot give Risky Moves, Evasive Expert)**
-   _Cutthroat_ (Blood Thirsty, In a Hurry, Muffled Screams)
-   _Duelist_ (Concussive Force, Precise Swing, Steady Nerves, Strong Hold) **(Note; Cannot give Concussion, Spine Cutter, Strong Stern, Tap Dancer)**
...
-   _Leader_ (Callout, Spotter)
-   _Politician_ (Cult of Personality, Pardon Me)
-   _Public Figure_ (Celebrity, Under the Radar, You'll Need To Get Past Me)
-   _Silvertongue_ (Snake Oil, Friends in High Places, Golden Tongue)
-   _Showboater_ (Unnecessary Theatrics)
-   _The Negotiator_ (Last Second Negotiations)
-   _Thief_ (Cap Artist, Pickpocket, Master Thief, Another Man's Trash)
-   _Toxic Personality_ (Manipulator, Narcissist)
-   _Tyrant_ (No Survivors, Audacity) **(Note; Cannot give Rule Through Fear)**
...
-   _Saboteur_ (Needs: [Family Recipe](Quests.md)) (Incendiary Formula, Explosive Efficiency, Sulphur Surprise, Hot Potato, Pocket Bombs)
-   _Seeker of Sound_ (Dragon's Song)
-   _Survival Instinct_ (Herbivore, Iron Gut, Termite)
-   _Tavernkeep_ (Master Chef, Artisan Chef)
-   _Waterborne_ (Conditioned Swimmer) **(Note; Cannot give Scuba Drowner)**
...
-   _Flamecharmer_ (Azure Flames, Produce Spark, Unyielding Inferno)
-   _Amoran Seeker_ (Flame Within)
-   _Duelist Flame_ (Concussive Flash)
-   _Falling Star Guard_ (Meteor Impact, Phoenix Impact)
...
-   _Frostdrawer_ (Cold Front, Glacial Ice)
...
-   _Thundercaller_ (Discovery of Fire, Shocking Finish, Static Flash Clone, Stratoshock)
-   _Authority Interrogator_ (First Interrogation, Second Interrogation, Authority Intimidation, Resolve Crusher)
-   _Jumpstarter_ (Electrify, Amplified Rage, Amplified Reflexes)
...
-   _Thunder Brawler_ (Discharge)
-   _Unstable Capacitor_ (Surge Path: Unstable Capacitor, Battery Sapper, Catalytic Strike, Closed Circuit, Fried Circuits, Human Battery)
...
-   _Heat Column_ (Fan the Flames)
-   _Lichtenberg_ (Scorched Peak)
-   _Pyroclast_ (Volcanic Glass)
-   _Stormcaller_ (Storm Link)
-   _Superconductor_ (Voltaic Conductor)
-   _Twisted Puppets_ (Wraith Path: Twisted Puppets, Burning Puppets, Explosive Rage, Moths to a Flame) **(Note; Cannot grant Burning Sacrifice)**
-   _Vaporborne_ (Flashboil, Boiling Point)
...
-   I seek Hybrid Mantras (☆☆☆) -> (★★★) **(Note; can only give hybrid Attunement mantras)**
