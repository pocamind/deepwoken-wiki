...
Mystics are [Chrysid](Chrysid.md) NPCs that appears in multiple locations around the map. For 20, they will prompt you with Mantra categories. Upon picking a prompt, the next time you obtain a [Whisper Draw](Whisper_Draw.md), you will be guaranteed to get at least 1 Mantra of that type. This interaction can be repeated infinite number of times with sufficient number of Notes. Before powering up, the last prompt you choose will overwrite whatever other prompts you chose.
...
Note that you can only get prompts for Mantra types that you are eligible to obtain, and your Whisper Draw may not be exclusively that Mantra type.
