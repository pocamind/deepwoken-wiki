...
(★☆☆)
 ...
 | The Kyrsgarde Champion spins its glaive in the air before slamming into the ground, causing three pillars of ice to erupt in succesion from beneath the player.
...
(★☆☆)
 ...
 | The Kyrsgarde Champion performs two low slashes with its glaive, before spinning into a high slash.

-   the third slash is marked by a yellow indicator, crouch to avoid this attack.
...
(★★☆)
 ...
 | The Champion lets out a swift thrust with its glaive.
...
(★★★)
 ...
 | The Kyrsgarde Champion uses its glaive to execute two slashes, followed by a sweep that must be jumped over, and an overhead slash that must be avoided by dodging.
...
-   Kills against the Kyrsgarde Champion contribute towards the general Kyrsgarde [Bestiary](Bestiary.md) entry, so the boosts from that entry should also apply against him.
