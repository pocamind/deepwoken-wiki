...
| enchantable | Yes |
| pass down | Yes |
| obtainment | Second Layer, Chaser, Scion of Ethiron, The Diluvian Mechanism, Pure Astruline Turn-ins, Chime of Conflict, Fishing, Primadon, First Layer, The Doom of Caeranthil, War Mode |
| description | "Summon a temporary storm at your location." |

## Description

The **Rain Spire** is a reusable [Relic](Relics.md) similar in design to the [Void Spire](Void_Spire.md) that allows its user to summon [Rain](Environmental_Hazards.md) and [fishing spots](Fishing.md) for 5 minutes. It has infinite uses but has a 40 minute cooldown
...
-   Rain Spire can be used to buff the [Storm Enchant](Enchantments.md), which makes it summon a bolt of lightning on proc increasing it's damage by 17.5%.
