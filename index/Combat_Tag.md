...
Combat tag, or In Combat (In Danger), is the state you enter when being parried by an enemy or attacked by an enemy in any way and can be prolonged by being hit multiple times, resetting the timer, or added by being attacked by multiple enemies.

_(Note: Allies Through [Vow Of Mastery,](Vow_of_Mastery.md) [Vow Of Allegiance,](Combat_Mechanics.md) or [GuildMates](Guilds.md) do not proc Combat Tag.)_
...
-   Your Natural Health Regain Is Reduced, as well as the healing From [Campfires](Campfire_Pit.md).
-   Some [Talents](Talents.md) Proc upon Inflecting a Combat Tag or by being hit into it.
    -   _Example: [Ready Or Not](Talents.md) will Reduce the amount of Damage the first hit towards you outside of Combat By half._
...
1.  You cannot switch weapons or armor during combat.
...
When the Skull At the top appears PvP or PvE, it will also say a quote under the Skull, it also shares the Skull Color, These quotes will vary depending on your state, and Location.

List of Quotes:

1.  The End Draws Near.

_I don't know all of them ):_

## Trivia/Notes

-   The [Oath, Silentheart (_New)_](Oath%253A_Silentheart.md), Can switch weapons in Combat and has a Button to do so.
...
-   Once in Combat you cannot Backstab.
-   [Lord Regent,](The_Lord_Regent.md) Applies Combat When he Attacks you with [Judgment](Oath%253A_Contractor.md).
