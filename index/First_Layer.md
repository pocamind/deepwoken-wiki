...
-   _**Corrupted Monsters**_ are the juiciest part of Depths Farming. Identified by the purple haze/mist surrounding them, these mobs act like their regular counterparts but have 3x HP and 2x damage. These grant [Chests](Chests_&_Sacks.md) with even better high tier/endgame loot.
...
-   If a monster is chasing you, try to attract some Lesser Angels. Angels are very hostile to almost all monsters inside the Depths, so if you can try to attract the Lesser Angels to you this won't always work as you need to leave the area for the Lesser Angels to lock on the monster you were being chased.
