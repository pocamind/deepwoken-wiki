...
(For those that don't understand. (without escaping already) **1-9 is 1-3, 10-19 is 4-6, 20-29 is 7-10, 30-49 is 11-16 and Enforcer is 17+**) —> this is correct, but trial power is different from actual power, I recommend that you make a separate column where you list usual power levels, this should solve our problems.
