...
-   If you find yourself in the Depths with very little health, there are some options for you. These options include standing still for 15 seconds, which allows you to heal pretty fast after the 15 seconds, killing a low-level mob (i.e a Jellyfish or a Mudskipper) for healthpack, or a friend that can place a Graceful Flame for you (A support flame mantra).
...
-   It is advised to carry a [Repair Kit](Repair_Kit.md) in case your armor bar is gone, unless you have graceful flames, or a campfire.
...
-   When traversing inside [The City of the Drowned](The_City_of_the_Drowned.md), try to stay on top of buildings or higher surfaces, as mobs spawn easier, and can attack you easier if you stay on the ground.
