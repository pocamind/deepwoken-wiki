...
| enchantable | Yes |
| pass down | Yes |
| obtainment | Finding a Blazing enchanted weapon in a chest, LaplaceEnchant Stone:, Exchanging 5 to Klaris (grants a random non-exclusive Enchant Stone), War Mode, Hell Mode, Scion of Ethiron, Maestro Evengarde Rest, Dread Serpent, Heart of Enmity, Chaser, Scholar of the Crimson Contract, Saramaed Hollow, Second Layer, Diluvian Mechanism, Galewax Room in the Second Layer, Crafting :Vow of Iron, Sold in Naan Zakshun's black market for 4,000 |
| description | Once enough stacks have been applied, for 5s your weapon attacks will ignite your foes. |

## Description

Blazing is a damage dealing enchantment that applies burn to your opponent.

This enchantment changes your weapon's color to a charred brown and covers it with orange flame particles. Blazing's flame particle color changes depending on your [Flamecharm](Flamecharm.md) color, turning blue if you have [Azure Flames](Talents.md#azure-flames) or black if you have [Wraith Path: Twisted Puppets](Talents.md#wraith-path-twisted-puppets).
...
-   Blazing's [burn](Status_Effects.md#burn) scales on your [Flamecharm](Flamecharm.md) investment and benefits from all of your burn Talents just like any other source of burn.
    ...
    -   If you have [Eruption Path](Talents.md#lava-serpent), this will proc an Eruption instead of applying burn. Eruptions have a 3 second cooldown.
    -   If you have [Twisted Puppets](Talents.md#twisted-puppets), this will apply 'Puppet Burn', spawning Puppets and draining Ether. Puppets have a 4 second spawn cooldown, though the burn can still be applied while Puppet spawning is on cooldown.
