...
|---|---|
| type | Greataxe |
| requirements | 75 FROST, LVL 10, 30 HVY |
| damage | 24 |
| scaling | ICE: 8, HVY: 4 |
| range | 8.5 |
| swing speed | 0.83x |
...
| enchantable | Yes |
| pass down | Yes |
| obtainment | Crypt of the Unbroken (Chest), Scion of Ethiron (Chest), Chaser, Scholar of the Burning Blood (Chest), Layer 2, Ministry ambushes (chest), Diluvian Mechanism (wave 30-50) |
...
**Gran Sudaruska** is a Legendary [Greataxe](Weapons.md): a tall and heavy black-winged battleaxe, fused by frost and Sudaruska's soul, lighting it with cold color. It scales with both Heavy and [Frostdraw](Frostdraw.md).
