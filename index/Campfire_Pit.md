...
Can be lit up by using a Flint (1 Coal + 1 Rock), using [Produce Spark](Flamecharm.md#talents), [Discovery of Fire](Thundercall.md#talents), [Flame Wisp](Flamecharm.md#mantras), Umbral Flint, or using Fire Gun.
