...
This Outfit also grants the [Talent Card](Talents.md) _Ferryman's Curse_, which has a 20% chance to convert incoming elemental damage into Lightning damage. With its high elemental resistance, reducing most mantras damage by a third, this gives a chance to reduce mantra damage by more than half. The 20% convert chance result in an average of 40% mantra resistance (to non lightning mantras).
...
-   This item cannot be dropped nor banked.
...
-   This Outfit can go extremely well with the [Oath: Silentheart](Oath%253A_Silentheart.md), the elemental resistance and Ferryman's Curse pairing well together with the high mantra resistance of SilentHeart build's can make many Mantras (Specifically Multi-Hits) lose more than 60% of their damage.
