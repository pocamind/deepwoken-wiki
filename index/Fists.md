...
Fists are a unique type of [Light Weapon](Light_Weapons.md), being a collection of multiple martial arts styles rather than solely being one weapon type with distinct animations. Fists can be equipped at any time (even during combat) by unequipping your current weapon or using one of the Fist Style Talent tools.

These weapons are typically locked to the One Handed stance.

## Styles

Fist Styles are unlockable martial arts techniques that change the animations and criticals of your Fist weapons. Instead of stance swapping, the Y key will swap your Fist Style. Style swapping has a 8 second cooldown.

Each style has a [Master Armor](Outfits.md) associated with it, granting additional unique benefits when using the respective style.

The following is a brief overview of the styles and their Master Armors. For more information, please view their individual pages.
...
[Imperium Kata](Imperium_Kata.md); an advanced [Hundred Legions](Hundred_Legions.md) martial arts. Its critical consists of two brutal kicks.

Using the [Legion Centurion](Legion_Centurion.md) Outfit grants this style, and its sister style, [Legion Kata](Legion_Kata.md) 4% more damage.

**Jus Karita:**

[Jus Karita](Jus_Karita.md) is a unique fist style, created by the [Justicars](The_Justicar.md). Its critical is a spinning kick attack.

Unlike all other styles, this Fist Style is a **Kick Style**, meaning it cannot equip Cestus weapons. To make up for this, Jus Karita's bare hands has unique stats compared to all other Fist Styles. Additionally, Jus Karita has unique Talents and Mantras, something entirely unseen with all other Fist Styles.

Using the [Justicar's Armor](<Justicar's_Armor.md>) Outfit grants a 10% damage buff to this style.

**Legion Kata:**

[Legion Kata](Legion_Kata.md); the standard martial arts of the [Hundred Legions](Hundred_Legions.md). Its critical is a grapple attack that ends with an overhead slam.

Using the [Legion Centurion](Legion_Centurion.md) Outfit grants this style, and its sister style, [Imperium Kata](Imperium_Kata.md) 4% more damage.
...
[Way of Navae](Way_of_Navae.md); a Fist Style used by the [Navaen Nomads](Children_of_Navae.md). Its critical consists of a guardbreaking overhead kick.

Using the [Navaen War Chief](Navaen_War_Chief.md) Outfit will grant +10% PEN to Way of Navae M1s and criticals with the [M1 tag](M1_tag.md).
...
The Fists weapon class comes with a set of default weapon animations.
...
If the [Jade Vigil's Weave](<Jade_Vigil's_Weave.md>) Outfit is equipped, you will additionally gain this style's running critical, a front-flip followed by a dazing knock-down stomp with a wide AoE. This has a scaled damage multiplier of **1x** and deals **10** posture damage with **10%** chip damage. This attack dazes and knockdowns for **0.95** seconds, and with a short windup of **0.5s** and endlag of **0.25s**. This attack has a **5 second cooldown**.
...
The first hit deals **1.2x** your weapon's **base damage**, and the second hit deals **2x** your weapon's **base damage**. If blocked, this critical will deal **6.8** posture damage on the first hit and **10.2** on the second. This is a flat value that does not change based on your Posture Damage stat.

Imperium Kata's critical gains **5** [Thundercall](Thundercall.md) Scaling if you have [Electrify](Talents.md#electrify) active.
...
-   Unlike all other weapons, fist weapons make white particles instead of yellow when they hit a blocking enemy.
