...
There are several different style and all share the common ability of being able to be switched at any time, even mid combat.
...
-   ~You must talk to [Amara](Amara.md) inside the [Viper's Jaw](<The_Viper's_Jaw.md>) and ask her for training. You will then receive a quest to go help the Centurions on [Aratel Island](Aratel_Island.md),~ You don't need to get the quest from [Amara](Amara.md), you can just do the quest which is to help the Centurions during the Centurion VS Authority events on [Aratel Island](Aratel_Island.md). If you help the Centurions, your reputation among them will increase, and eventually you'll get enough reputation for you to ask for a recommendation. The last step will be to head to the [Viper's Jaw](<The_Viper's_Jaw.md>) and talking to [Amara](Amara.md). After that you'll acquire the talent to learn the Legion Kata fighting style.

-   After learning the Legion Martial Arts you'll still retain your Fist Fighting Style but more enhanced and honed. Your critical attack makes you perform a suplex.

-   You need good rep with the legion to get the recommendation from the captain. Debatably the best fist style. While Fist of Navae and Legion Kata tie in damage, the critical is faster and deals more damage. Whilst you're in the critical animation, the Kata user is able to spit on your opponent effectively giving the critical a lifesteal effect.

### Jus Karita

File:Jus Karita Description.png

#### **CRITICAL: Dash forward while performing a kick.**

-   Achieve a Power level of 30 and a Light Weapons attribute of 40.
-   Then, head to [Etris](Etris.md) and find Polis, the Vesperian polishing his Greatsword under the White Tree and ask him about the Jus Karita style. Keep the conversation going until you receive the talent that allows you to use Jus Karita in combat.
...
-   You can only equip Way Of Navae fighting style on character creation.
    -   This means if you get Legion Kata or Jus Karita and wipe you wont have them on character creation.
-   The Jus Karita fighting style can't equip a cestus.
    -   If you have two fist styles and try to equip a cestus on Jus Karita, the game will forcibly switch you to the way of Navae fist style.
-   Unlike all other weapons, fist styles make white particles instead of yellow when they hit a blocking enemy.
    -   Kind of correct as you're hitting metal with your bare fists.
