...
Castle Light is a safe area within the First Layer belonging to [The Divers](The_Divers.md). It is a castle with multiple lanterns floating around, brightening the surrounding area and making it visible from the outside. It's guarded by Black Diver NPCs and has a Life Barrier preventing entry. Entry will only be granted if the player has entered The Depths through a whirlpool or is using the [Deepbound Origin](Origins.md). It is also the only place to descend into layer 2 with friends and with a safety net through the form of the Life Hook.
...
-   Freshspawn [Deepbound](Origins.md) before layer 2 used to attempt to farm near here in hopes [jellyfish](Gigamed.md) would spawn. [Threshers](Thresher.md) did. Like, only threshers. _I'm serious._
