...
A Ministry Footpad is one of two enemies from [The Ministry](The_Ministry.md) that only appears in [Faction Ambushes](Faction_Ambushes.md).
...
Ministry Footpads are identical to [Ministry Scouts](Ministry_Scout.md), except they can only be found in [Faction Ambushes](Faction_Ambushes.md). They spawn in groups of 3 during [Ministry](The_Ministry.md) ambushes for lower-leveled players and/or players with a low reputation.

A Ministry Footpad's appearance consists of a [Vagabond's Bicorn](<Vagabond's_Bicorn.md>), either a [Blindfold](Blindfold.md) or Crimson Blindfold and a [Prophet's Cloak](<Prophet's_Cloak.md>) outfit with their [race](Aspects.md) varying.
