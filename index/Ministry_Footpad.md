...
A Ministry Footpad is one of two enemies from [The Ministry](The_Ministry.md) that only appears in [Faction Ambushes](Faction_Ambushes.md). Template:EnemyInfobox1.0
...
A Ministry Footpad's appearance is identical to that of a Ministry Scout. It consists of a [Vagabond's Bicorn](<Vagabond's_Bicorn.md>), either a [Blindfold](Blindfold.md) or Crimson Blindfold and a [Prophet's Cloak](<Prophet's_Cloak.md>) outfit with their [race](Aspects.md) varying.
