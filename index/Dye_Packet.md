...
A Dye Packet is a [Relic](Relics.md) that can be obtained from [Klaris Llfiend, Mother of Lights](Klaris_Llfiend,_Mother_of_Lights.md) by handing in one [Kyrsan Medallion](Kyrsan_Medallions.md) per packet, getting it from the [Weird Trader](Weird_Trader.md), a chest from the [Carnival of Hearts](Carnival_of_Hearts.md), or rarely in [Merchant Ships](Travelling_Merchant.md) for around. It cannot be dropped but the dyed equipment can be dropped. Dye Remover no longer comes with the Dye Packet when you purchase one. Dye can be removed at a [Barber](Barber.md), or Dye Remover can be bought for. The maximum Dye Packets that can be held per slot is 99.
