...
The Evanspear War Plate is an [Equipment](Equipment.md) item under the "Legs" category, and is a part of the Evanspear War Set. The Evanspear War Boots are a set of green and yellow plated boots, made for high grip strength with the ground for pivoting. When worn, this grants +3 Health, +1 Uncommon Pip, and the [?](Talents.md#equipment-talents) Talent.
...
1.  1 [Evanspear War Boots](Evanspear_War_Boots.md) + 1 [Warden's Armor Piece](<Warden's_Armor_Piece.md>) + 2 [Wrath Gems](Wrath_Gem.md).
2.  1 [Evanspear War Boots](Evanspear_War_Boots.md) + 1 [Primadon Pelt](Primadon_Pelt.md) + ?.
3.  1 [Evanspear War Boots](Evanspear_War_Boots.md) + 1 [Doom of Caeranthil's Scale](<Doom_of_Caeranthil's_Scale.md>) + ?.
