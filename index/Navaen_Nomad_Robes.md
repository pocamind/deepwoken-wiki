...
This Outfit costs and requires five (5) Cloth and Fiber, eight (8) [Erisore](Ores.md#erisore), and two (2) Frigid Prisms.

This Outfit requires [Power Level](Power.md) 5.

### _Armor Stats_

This Outfit has 1800 durability, grants +10% Physical resistance, +10% Elemental resistance, +10% Blunt resistance, +15% Ice resistance, +15% Shadow resistance, and +50% Stealth. Additionally, it provides the [Fists of Navae](Talents.md#equipment-talents) Talent.
...
The [Fists of Navae](Talents.md#equipment-talents) Talent increases the users flourish timer while using Way of Navae from 2 seconds to 3 seconds.

## Obtainment

This Outfit's Schematic can be obtained from:

-   The Navaen Nomad camp at [Etrean Wilds](Etrean_Wilds.md)
-   [Erisia](Erisia.md)
