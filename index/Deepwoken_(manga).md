...
categories: ["Non-canon articles", Pages with broken file links, Deepwoken]
notices:
...
An [adventuring party](Unidentified_adventuring_party.md) are informed by an [old man](Unidentified_old_man.md) about the return of [the Duke](<The_Duke_(manga).md>), now hiding in the [Northern Temple](Northern_Temple.md). He notes that if the Duke is not stopped, he'll destroy the city, or worse, the entire island. An injured man reveals himself to be the only survivor who escaped from the Duke, and the old man recounts the history of the island: once beset by constant invasions, the island was nearly destroyed, though the Duke's science combined with the will of its people and [Marquis](Marquis.md) helped them hang on. The Duke eventually resorted to human experimentation, claiming many lives in the process and using their souls to create stone golems. The old man urges the party to defeat the Duke.
...
File:Deepwoken manga title.png

The title of the Deepwoken manga
