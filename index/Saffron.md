...
Saffron is a [Khan](Khan.md) NPC. They are one of the three disciples required for obtaining [Oathless](Oath%253A_Oathless.md) for the first time.

## Location

Saffron is located inside of the second story of a house at [Meteor Isle](Meteor_Isle.md).
...
-   Saffron wears the [Verdant Sniper](Verdant_Sniper.md) outfit.
-   If you already have an Oath, or not on the Oathless quest line, he will only say "..."
-   His [Khan](Khan.md) aspect variant is Albino.
-   He is named after a city in the Kanto region from the [_Pokémon_](https://en.wikipedia.org/wiki/Pok%C3%A9mon) franchise. Namely, [_Saffron City_](https://bulbapedia.bulbagarden.net/wiki/Saffron_City).
    -   This follows the same pattern with the other Oathless npcs. For more information you can look at [Cerulean](Cerulean.md), [Celadon](Celadon.md), and [Viridian](Viridian.md).
-   Saffron can mean the shade of the color yellow, or a spice. The spice being the color deep red.
-   Weirdly enough, Saffron has a unique dialogue compared to the other disciples, being "Those eyes... You wish to" and continue. While the others, [Viridian](Viridian.md) and [Celadon](Celadon.md), saying "Those eyes.. you wish to" and continue.
