...
Upon being slain, it drops [Megalodaunt Hide](Megalodaunt_Hide.md) and Mantra Modifiers, with a low chance of the modifiers being high-tier. It will also uncommonly drop [Umbral Obsidian](Umbral_Obsidian.md). Even rarer, It may drop a [Megalodaunt Coat](Outfits.md).
...
-   After a **Slash**, the Megalodaunt will usually follow up with a **Kick** or a **Slash**File:Slash.png. If **Slash**File:Slash.png is used twice consecutively, it will most likely be followed up with a **Kick**. Be wary, if the player dodges a **Slash**File:Slash.png expecting a **Kick**, their roll will be on cooldown for the next **Kick**.
    -   After the first two **Slashes**File:Slash.png, there is time to land two hits (depending on the weapon) before having to dodge or parry.
    -   After dodging a **Kick**, the player can always land a hit before having to dodge or parry.
-   There is around a 1/3 chance that the Megalodaunt will immediately **Kick** when the player initiates combat.
-   The player can dodge **Slash**File:Slash.png and a follow up **Kick** if they have a high attack speed weapon and the [Blade Dancer](https://deepwoken.fandom.com/wiki/Talents?so=search#Vigil_Swordsman) talent.
-   When the Megalodaunt prepares to use **Thousand Needles**, it will bend over and point their coral tubes at the player. This is a good indicator to start blocking or parrying.
...
-   The player's camera shakes when a Megalodaunt walks around their character, due to their giant size.
