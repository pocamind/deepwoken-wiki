...
-   In the back of the Ancient Rotlands lies a crash site of an unknown Celestial. This would later catch the attention of a [certain zealous group](The_Starkindred_Church.md).
...
-   Dropping deep into the cave will lead to a partially-flooded area containing four Nightmare Threshers. Upon defeating the Threshers, a chest containing many Legendary Rings will spawn.
...
-   Previously, there were two brains in the Rotlands that caused the player to lose [sanity](Insanity.md) when in its radius. Running out of sanity while near it would cause the player's head to explode. They were removed due to its nonsensical placement and function lorewise.
