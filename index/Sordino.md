...
The quest in question requires you to go to the [Lightkeeper Temple](Lightkeeper_Temple.md)/[Deep Thresher Nest](Deep_Thresher_Nest.md) and collect three Thresher Eggs before returning them to him, after which [Mounts](Beast_Whistle.md) will become purchasable for 3 [Crowns](Crowns.md). You only need to do this quest once to unlock the shop across all slots.
