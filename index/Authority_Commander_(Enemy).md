...
Authority Wardens are high-ranking members of The Central Authority. The rank of "Warden" fits them very well, they have the combat skills of an experienced player and a huge health pool, making them a true challenge.

Their appearance consists of the Authority Commander Uniform, a Shrouded Cape (Unknown Variant) and an Authority Helmet.

## Location

At least ONE Warden is located within [Fort Merit](Fort_Merit.md), in the prison area, in a room staring at some empty shelves. (They must know some FNAF lore)

## Moveset

Their arsenal is composed of a Medium or Heavy weapon (An Adretian Axe, An Officer Saber, or a Shotel), the [Flamecharm](Flamecharm.md) attunement, and the [Strong Left](Attunement-less.md) mantra:
...
-   Blocking the Strong Left is possible with a Khan Shield or the mantra Rally, that gives you decreased posture gain and makes it so that you can't be posture broken (some exceptions)
