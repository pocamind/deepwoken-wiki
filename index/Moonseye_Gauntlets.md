...
| enchantable | Yes |
| pass down | Yes |
| obtainment | First Layer, Maestro Evengarde Rest, The Diluvian Mechanism, Random Encounters (Sea Events) |
...
_This page is about the [Pathfinder](Pathfinder.md) equipment. For other uses, see [Moon (disambiguation)](<Moon_(disambiguation).md>)._
