...
| enchantable | No |
| pass down | Yes |
| obtainment | Pure Ore Rewards, Layer 2 Chests, Layer 1 Chests, Widow's Chest, Miner Chests, Fishing Chests, Chime Chests |
| description | A shield forged to brave the harshest of Ethironal winds, handcrafted by those who sought fortune amidst ruin. |

## Description

Ethiron's Curseshield is a darkly colored [Shield](Weapons.md), decorated with complex tangling patterns on its front side. It has a requirement of 50 FTD to use, and has 1.9 Weight.
...
-   Note that this shield seems to be heavily inspired from the Greatshield of Artorias from Dark Souls 1.
