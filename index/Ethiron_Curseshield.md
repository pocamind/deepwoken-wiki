...
| enchantable | No |
| pass down | Yes |
| obtainment | Pure Ore Rewards, Fishing Chests, Derelict Highchurch (Ministry Bloodrender event), New Kyrsa, The Sleeping City, The Eternal Gale, Chime of Conflict Chests, Depths Island Sea Events, Faction Ambushes (The Divers), Hell Mode brown chests, Scyphozia, Scyphozia jobs, Bounties, The Diluvian Mechanism |
| description | A shield forged to brave the harshest of Ethironal winds, handcrafted by those who sought fortune amidst ruin. |

## Description

The Ethiron Curseshield is a darkly colored [Shield](Weapons.md), decorated with complex tangling patterns on its front side. It has a requirement of 50 FTD to use, and has 1.9 Weight.
