...
Failing to survive in The Depths and perishing will result in you being sent to the [Fragments of Self](Fragments_of_Self.md). This is basically the afterlife, the final memories of the character. There is not much you can do here. You'll have to wipe or character or you can pay Robux (500) to return to the Etrean Luminant commonly referred as using Last Wind (You can only use this once per character). There is also a [pool](Hippocampal_Pool.md) where you can give up to two items (or four depending on your [Echoes](Echoes.md) upgrade) to pass on to your future character of the same slot.
