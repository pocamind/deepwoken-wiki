...
-   _Lightning Strike_ prints out the coordinates of where the strike was in the F9 log (No it doesn't). This means that you can use _Lightning Strike_ as a makeshift or bootleg compass (No you can't).
