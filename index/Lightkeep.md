...
-   One of a **Lightkeeper's** primary characteristics is to re-illuminate long forgotten structures through their **Lightkeep**.
-   Because of the existence of [Dawnwalkers](Oaths.md#dawnwalker), it is theorized that the **Lightkeepers** were fierce wizards, capable of utilizing devastating magic.
-   Although never stated, **Lightkeep** _(to retain light)_, as the antithetical [Attunement](Attunements.md) of [Shadowcast](Shadowcast.md) _(to throw shadows or darken light)_, that Lightkeep is assumed to be capable of dispelling [Shadowcast](Shadowcast.md) magic and possible other effects, through purification, similar to the [Dawnwalker](Oaths.md#dawnwalker) Oath.
-   **Lightkeep** is never explictly stated to be light yellow, but is assumed by the general population due to its connections to holiness, purity, and the opposite of deep purple. It could also be rainbow, but more likely colors ranging from white to light purples, blues, and greens.
