...
| type | Greatsword |
| requirements | Base: 20 HVY, 10 STR, Alloyed: 75 HVY, 10 STR, Bloodbane: 60 HVY, 30 STR |
| damage | 22 / 23 / 20 |
| scaling | HVY: 7 / 10 / 5 |
| range | 9 |
...
| endlag | 0.1s |
| penetration | 10% |
| special effect | Bloodbane: Applies a bloodletting DoT effect on critical. If you are knocked during this effect's lifespan, you will be instantly gripped. |
...
| enchantable | Yes |
| pass down | Yes |
| obtainment | Etris Weaponry (100 ), Erisia, Dread Serpent, LodestarAlloyed:, Alloying a ZweihanderBloodbane:, Elder Primadon |
| description | Popularised by the Canor Borderwatchers, the Zweihander is as fearsome as it is heavy., An heirloom of the Canor Borderwatchers, this bloodsoaked zweihander has been passed down by its leaders for generations. At times, you swear you can feel a heartbeat resounding from within. |

## Description

The **Zweihander** is a standard Heavy Greatsword that can act as an entry point to the Greatsword weapon class. The Zweihander has two upgraded variants, the Alloyed Zweihander and the Bloodbane.
