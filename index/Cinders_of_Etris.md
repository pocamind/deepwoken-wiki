...
-   This event is intended to be disabled so that it can be reworked into a [World Events](World_Events.md). However, it is not, which also allows it to spawn in [Vow of Iron](Vow_of_Iron.md).
