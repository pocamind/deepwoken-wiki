...
categories: [Weapons, Greathammers, "Core-Attribute based weapons", Weapons with Unique Criticals, "Weapons with Multi-Hit Criticals", Heavy Weapons, Weapons of Etrea]
---
...
| enchantable | Yes |
| pass down | Yes |
| obtainment | Maestro Evengarde Rest, Duke Erisia, War Mode, Cinders of Etris, Interluminary Parasol, The Doom of Caeranthil, FishingVow of Iron:, Viridian Sanctuary Ruins |
...
For the **running** critical, the user winds up before unleashing two unblockable slams each dealing **0.5x scaled damage** followed by a larger third slam that ragdolls and knocks away, dealing **0.6x scaled damage.** This critical has [Hyperarmor](Hyperarmor.md), but cancels on dodge or parry.
