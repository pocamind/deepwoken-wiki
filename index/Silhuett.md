...
If the player has high Ally [reputation](Reputation.md) with [The Ministry](The_Ministry.md), then they can convince the Ministry Agent to hand over the Deepspindle, Darkscorn Casque and Darkened Bastion without a fight, but only if they teleported to him through Silhuett. If they reached him through other methods, they will instead face a [Black Diver](<Black_Diver_(NPC).md>) or a [Mudskipper Broodlord](Mudskipper_Broodlord.md).
