...
<tr>
  ...
  If the user has Crystallization, apply an ice crystal. Can only apply a total of 1 crystal. Cannot apply any more crystals until the crystals break. This applies a 0.4 second chill effect (only without crystal).</p></div></td>
...
<tr>
  ...
  The victim takes 1/14 of the initial damage every 0.25s 10 times. Every hit after the initial hit bypasses iframes.</p></div></td>
...
<tr>
  ...
  By having the Surge Path: Unstable Capacitor talent, your m1s will no longer stun your opponent but will add rods to them.<br>
  In the rain, M1 connections will also summon a bolt of lightning on the opponent, increasing damage by 17.5%.</p></div></td>
