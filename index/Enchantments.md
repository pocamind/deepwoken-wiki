...
**Enchantments** are powerful upgrades for your bitches & whores.
...
-   Talking to mommy klariz allows you to turn 5 [Kyrsan Medallions](Kyrsan_Medallions.md) into either a random equipment enchant (you can roll the same enchant twice in a row) **or** a random enchant stone.
...
-   **April 5th, 2024** - [Railbades](Railblade.md) are no longer considered Legendary Weapons, thus they can be enchanted.
