...
-   [Crimson Megalodaunt](Crimson_Megalodaunt.md)
...
Sacks are in-game bags that spawn after a player has died. They contain a stash of items from the deceased player's inventory, but not all as there is a limit for how many items there could be in the sack.

Similar to chests, loot inside the sack will appear in different colors depending on the rarity of the items sorting from Legendary to Common. It is noted that the sacks despawn after ~15 minutes.
