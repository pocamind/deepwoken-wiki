...
| M1 + M2 + mantra | Mantra Feint | Player cancels event/animation of Mantras when using them. Costs Ether but resets the cooldown. |
...
| Ctrl or C | Crouch | Player enables [Stealth](Stealth.md). |
...
| W+Space while airborne and near wall | Wall Jump | Parkour. Player performs two small hops on a wall, automatically hops up and over ledges if holding W. |
