...
-   The fight is a homage to _[Sekiro: Shadows Die Twice](https://en.wikipedia.org/wiki/Sekiro:_Shadows_Die_Twice)_, the game that inspired Deepwoked setting. Many of the moves reference its abilities and bosses, such as [Genichiro Ashina](https://sekiro-shadows-die-twice.fandom.com/wiki/Genichiro_Ashina) or the [One Mind Combat Art](https://sekiro-shadows-die-twice.fandom.com/wiki/One_Mind).
...
-   Maestro is bugged and movestacks like his slots depends on it as of July 3 2025 remove when fixed (this is other person, august 13-14 hotfixes list tells its fixed but idk i didnt test can someone test it)
