...
-   Abyss Wanderer's Boots are part of the "**Abyss Wanderer**" set, with the only other piece being the [**Abyss Wanderer's Plate**](<Abyss_Wanderer's_Plate.md>).
    -   Oddly, the boots are of Legendary rarity while the plate is Mythical. If looking for the full set, make sure to check the Legendary items (Cyan) in the chest to not miss them.
