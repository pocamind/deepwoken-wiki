...
categories: [Pathfinder Exclusive, Mechanics, Guilds, Items, Tools]
---
...
The Chime of Dwelling is an obtainable item added in the [Verse 2 Update](Verse_2.md) which is granted to the Officers, Lieutenants and the Leader of a Guild. It allows you to set a [Guild Base](Guild_Bases.md) in a wall, with some exceptions (see below).
