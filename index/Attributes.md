...
-   Unlocks Willpower-related [Talents](Talents.md) and [Mantras](Attunement-less.md#willpower-mantras), and the legendary weapon [Light's Final Toll](<Light's_Final_Toll.md>) with a requirement of 60 Willpower and 30 Light weapon.
...
-   Gain Charisma EXP by selling items, getting good reputation with a faction, playing an instrument, using the Encyclopedia (this will train your Intelligence at the same time) and using the _How To Make Friends_ book.
