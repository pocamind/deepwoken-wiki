...
-   You cannot remove innate attribute points granted by your aspect.
    -   This limitation will be removed if you have the [Multifaceted](../Multifaceted.md) Echo Unlock, as it converts innate attribute points into regular investment points.
-   You cannot reduce an attribute if you have Talent(s) that require equal to or higher investment on that attribute.
    ...
    -   This restriction does not apply to the following Talent requirement types, allowing you to freely uninvest:
        ...
        -   Category attributes on Talents that require attribute category investment ([Mind](../Mind.md), [Body](../Body.md), Element, and Weapon). For example, if you have [Grounding Bolt](../Talents.md#grounding-bolt) (90 Thundercall, 90 Weapon), you can reduce your Weapon investment, but not your Thundercall investment.
        ...
        -   Attribute requirements for Oath Talents; You can reduce your attributes below your Oath's requirements.
            -   The only exception to this is [Arcwarder](../Arcwarder.md) in most scenarios, as you cannot lower your Attunement stats due to the Attunement Adept Talents. This however, can be avoided by using [Shrine of Order](../Shrine_of_Order.md) to go _up_ to exactly 20 Flamecharm and/or 20 Thundercall, obtaining the Oath, and then going to Shrine of Mastery. Keep in mind that if you invest any attribute points, die (including resetting your character), or leave the game, it will give you the Attunement Adept Talent, preventing you from uninvesting.
...
-   If you no longer meet the requirements for your weapon after using Shrine of Mastery, you will keep it equipped, but you'll receive a penalty, lowering your weapon's damage. This debuff scales on how far below your weapon's requirements you are, up to a maximum of -25% base damage, though the math behind it makes it only really effective on lower requirement weapons.
    ...
    -   [Khan](../Khan.md) and [Silentheart](../Silentheart.md)'s requirement reduction is applied in these calculations.
...
-   This Shrine does not count for the "Bargained with Deep Shrines" [Echo Triumph](../Echo_Triumph.md).
