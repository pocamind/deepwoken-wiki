...
-   Mugging a downed player with the [Pickpocket](Talents.md#thief) Talent.
...
There are many means to obtain Notes, with some being better than others.

##### Most Efficient

-   1 [Knowledge](Knowledge.md) is worth 300 Notes at the [Soothsayer](Soothsayer.md), so the [Moonseye Tome](Moonseye_Tome.md) or [Klaris](Klaris_Llfiend,_Mother_of_Lights.md)' [Knowledge](Knowledge.md) for [Kyrsan Medallions](Kyrsan_Medallions.md) exchanges can give a lot of notes in the long run.
...
-   [Voidwalkers](Voidwalker.md) specifically benefit from being able to access [Antiquarians](Antiquarian.md) faster than other [Origins](Origins.md) if farming [Primadon](Primadon,_Titan_of_the_East.md) or [The Ferryman](The_Ferryman.md) due to others being unable to access [Guild Bases](Guild_Bases.md) directly at their locations. The former drops a massive amount of items and the latter drops many high-value items. Bear in mind the Voideye cooldown, however. The Voideye can also be substituted with the Ouroboral Husk as it allows unlimited access to an Antiquarian without a cooldown or being a Voidwalker
-   [Crypt of the Unbroken](Crypt_of_the_Unbroken.md) can be farmed extremely quickly, especially using an assassination-based build. Getting all 5 chests can take as little as 2 minutes if you know what you're doing. However, the rate you get items at is too fast for the [Voideye](Voidwalker.md#voideye) cooldown, so unless you have a [Guild Base](Guild_Bases.md) with an [Antiquarian](Antiquarian.md) or an [Ouroboral Husk](Ouroboral_Husk.md), it won't be as effective.
...
-   Farming as a [Deepbound](Deepbound.md) varies in pace and danger, but the undesired contents of chests are frequently left alone and chests drop a good amount of items. Call of the Deep can be used to return to [Castle Light](Castle_Light.md) if farming elsewhere in [the Depths](The_Depths.md), but you can also farm near [Light's Causeway](<Light's_Causeway.md>).
    -   [Ignition Delvers](Ignition_Delver.md) can access jobs from anywhere in [the Depths](The_Depths.md), making [events](Random_Encounters.md) even easier to encounter.
...
-   The following are only accessible for those who can access the [Voidheart](Voidheart.md)'s [Antiquarian](Antiquarian.md) as a [Voidwalker](Voidwalker.md), the [Saramaed Hollow](Saramaed_Hollow.md)'s [Antiquarian](Antiquarian.md) via the [Ouroboral Husk](Ouroboral_Husk.md), or a [Guild Base](Guild_Bases.md)'s [Antiquarian](Antiquarian.md).
    -   Reaching an area where [Guild Bases](Guild_Bases.md) can be placed does not take too long after fighting [Duke Erisia](Duke_Ishamon_Erisia.md).

##### Not Efficient

-   [Sea Islands](Random_Encounters.md#sea-events) drop a lot of items, but are often slow to reach and clear.
-   If not a [Deepbound](Deepbound.md) or [Ignition Delver](Ignition_Delver.md), farming in [the Depths](The_Depths.md) for Notes is not worth it due to the time it takes to enter and leave [the Depths](The_Depths.md) to access an [Antiquarian](Antiquarian.md).
