...
Variants: [Parka](Winter_Corps_Parka.md)

## Description

Winter Corps Boots are an [Equipment](Equipment.md) item under the "Legs" category.

They can be found through chests in [Miner's Landing](<Miner's_Landing.md>), the [Second Layer](Second_Layer.md) and the [Crypt of the Unbroken](Crypt_of_the_Unbroken.md).
