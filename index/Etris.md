...
Variants: [Etris (Vow of Iron)](<Etris_(Vow_of_Iron).md>)
...
-   Players can speak to the [Innkeep](Innkeep.md) to change their spawn to Etrea for 5.
-   [Trenti](Trenti.md) resides here, giving advice to new players.

### Bank

-   Players can find a [Banker](Banker.md) they can turn found [Artifacts](Artifacts.md) in to, as well as store items and deposit [Notes](Notes.md) across all of their slots.
...
-   Players can find [Caragan](Caragan.md), the Etris [Blacksmith](Blacksmith.md).
-   [Cloth](Cloth.md) and [Fiber](Fiber.md) can be directly purchased from Caragan, but are also sold outside of the Blacksmith by [Pori](Pori.md), who can give you a 50% discount on them if you talk to him.
    -   However you are still unable to purchase Cloth or Fiber unless you can afford their base price.
...
-   Players can buy a variety of starter [Weapons](Weapons.md) around the shop and some directly from [Astra](Astra.md) here:
    ...
    -   [Steel Maulfor](Steel_Maul.md) 100.
    -   [Zweihander](Zweihander.md) for 100.
    -   [Targe](Targe.md) for 15.
    -   [Parrying Dagger](Parrying_Dagger.md) for 25.
...
-   Struggling to stay afloat from competition, [Chef Odiolavoro](Chef_Odiolavoro.md) can assign you to cook meals for them in return for rewards and the chance of unique weapons.

### Guildhall

-   Players can start a Guild when they reach [Power](Power.md) 5 by talking to the [Guild Clerk](Guild_Clerk.md).
...
-   The [Den Master](Den_Master.md) can be found here. They sell all Tier 1 [Mantra Modifiers](Mantra_Modifiers.md)
-   To get there sail to the right of the docks and loop around the mountains.

### Alchemist's Lodge

-   [Nell, Master of Frost](Nell,_Master_of_Frost.md), the [Frostdraw](Frostdraw.md) trainer can be found here.
-   A functional [Cauldron](Cauldron.md) can be found here.

### Miscellaneous

-   [Polis](Polis.md) can be found in the middle of the city. If you follow the first dialogue, he will give you a [Gold Ring](Gold_Ring.md).
...
-   He mutters about lacking the necessary ingredients; agreeing to help him requires 2 [Dying Embers](Dying_Embers.md).
-   The reward for completing this quest is a random high tier [Mantra Modifier](Mantra_Modifiers.md) and a Curiosity Talent hand.

### Lumberjack Quest

-   Speak to [Korin](Korin.md) who is idling outside a house by the exit to the [Etrean Wilds](Etrean_Wilds.md).
-   They will ask you to chop wood so that they have a sustainable supply of lumber for the winter.
-   Accepting the quest gives you a lumber axe for free if you don't have one already.
-   Turning in 6 wood for gives back 5.
...
-   Talk to [Korin](Korin.md) and tell them you don't get any wood by punching trees.
-   Bewildered, the Etrean offers the player to Strong Left 5 trees for research.
-   After 5 trees are felled with Strong Left, return to the Lumberjack and gain the Talent.

### Travelling Blade

-   Talk to [Nanji](Nanji.md) in Etris, located near the big slope ramp close to the [Barber](Barber.md).
-   They mention about a missing individual, their brother [Ilji](Ilji.md), whom they were supposed to meet in Etris. Agreeing to help find this person accepts the quest.
-   The [Chipped Sword](Chipped_Sword.md) that was used by [Ilji](Ilji.md) can be found on the small island connecting the [Isle of Vigils](Isle_of_Vigils.md) to [Upper Erisia](Upper_Erisia.md).
-   Returning to Nanji grants the [Nanji's Training](Talents.md#nanjis-training) Talent, reputation with Etrea, and Compassion Talent hand.
...
-   Accepting to escort her activates the quest. Meet her at the [The Viper's Jaw](<The_Viper's_Jaw.md>), located in Lower Erisia. (She is located near the zip line placement near the ruins, on top of the cave deposit in Pathfinder's Respite.
...
-   By choosing to continue the escort, Karliah will enter the cave and almost immediately get attacked by [Horseshoe Crabs](Horseshoe_Crab.md).
-   There is no reward for this ending. (The four horseshoe crabs on the ground can be seen beforehand but cannot be attacked or killed, neither before or during the attack. This route is meant only as some twisted ending.)
...
-   Picking the 2nd option, Karliah returns back home and studies. If the Player checks up on Karliah's Home in Etris, she is covered in blood and mentally deranged, along with petting the head of [Joshua](Joshua.md) who she once helped.
...
-   Picking the 3rd option (which requires atleast 50 Charisma), Karliah accepts your harsh honesty, and retires from being a Depths Diver. She goes back home in Etris.
...
-   The reward from this unbounds your Charisma, a fistful of EXP, and a moment of harmony and relief.
...
This is a disaster that happens every other hour. Fire and smoke clouds will cover over Etris.
...
At the beginning of the disaster, the Authority will begin to invade Etris, starting at the docks and making their way up to the city's center. Lesser Etrean Foot-soldiers and Royal Guards will spawn in to aid Etris. Polis will also fight as a unique enemy.

After all Authority Guards are defeated, peace is restored and all participating players receive a chest with mid and endgame loot.

### Ploom's Embers

-   Talk to Ploom, located in Lance's Food.
-   Further through the dialogue, you can choose 3 ways of doing this quest.
    1.  Do the quest normally and accept his offer. Fetch him 3 Dying Embers.
...
-   Find and rescue a [Navaen Hostage](Navaen_Hostage.md) in Erisia, in one of the many encounters there.
-   Upon finding a Navaen tribe member, head back to [Cheral](Cheral.md) and receive your reward.
-   The reward for this quest is the [Way of Navae](Fists.md) fist style and Talent. In addition, it unlocks a new dialogue option from Polis. It also will prompt "Way of Navae" to be a starting style in the start menu.
