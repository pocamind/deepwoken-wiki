...
-   Players can find a [banker](Banker.md) they can turn found [artifacts](Artifacts.md) in to, as well as store items across all of their slots.
...
-   Players can start a Guild when they reach [Power](Power.md) 5 by talking to the Guildmaster.
...
-   Talk to [Nanji](Nanji.md) in Etris, located near the big slope ramp close to the [Alchemy](Alchemy.md) House.
-   She'll talk to you about a missing individual, whom she was supposed to meet in Etris. Agreeing to help find this person accepts the quest.
-   See [Nanji](Nanji.md) for info.
...
-   Kennith will ask you to talk to the locals of Etris about the [Lord Regent's](The_Lord_Regent.md) reputation as a ruler.
-   Talk to Bookkeeper Andros in the library.
...
-   Traverse through Erisia. Go through the [Towerstruck Lands](Towerstruck_Lands.md) and into the [Garden Reservoir](The_Garden_Reservoir.md); there, a portal will be seen, which leads to the Manor.
...
-   The reward of defeating the Duke unbounds [attunement](Attunements.md) and weapons. Note that you only need to defeat the Duke, for dying by the hands of Lord Regent does not grant any special reward.
...
-   By choosing to continue the escort, Karliah will enter the cave and almost immediately get attacked by horseshoe crabs.
...
This event is an extremely rare event that can happen in Etris. You can tell it's going on if there's a stormcloud over etris and buildings are on fire. Previously this event could only happen within the first few minutes of a server due to how events worked at the time, but since then it's been changed so the event can happen at any time in a server's lifespan.
...
At the beginning of the [Etris War Event](Cinders_of_Etris.md), the Authority will begin to invade Etris, starting at the docks and making their way up to the city's center. Lesser Etrean Foot-soldiers and Royal Guards will spawn in to aid Etris. Polis will also fight as a unique enemy.

After all Authority Guards are defeated, 3 large [chests](Chests_&_Sacks.md) holding high-tier [Depths](The_Depths.md) loot will spawn at the tree in the center of Etris.
...
-   Kennith reappears in an update (10/6/23) inside the [Kyrsan Wilds](Kyrsan_Wilds.md) of Floor 2 giving some interesting lore about Lord Regent.
