...
[Attributes](Attributes.md) are normally allowed to go up to 75. Obtaining these uncapping cards allow the player to go up to 100. Only a handful of Talents require stats past 75, so uncapping is not a necessity for every build.
...
6.  Lastly, eat one of the Bluecaps, _**in the same server you lit the braziers in.**_
...
Alternatively, weapon can also be unbounded by reaching 75 points on the desired weapon attribute and defeating any [Boss](Bosses.md).
