...
Their appearance consists of a Authority Captain Uniform, a Shrouded Cape and, unusually for an Authority member, [Polarised Sunglasses](Eyeglasses.md). They are similar in appearance to the [Authority Captain](Authority_Captain.md) and [Authority Commander](<Authority_Commander_(Enemy).md>). Their race can only be an [Adret](Adret.md).
