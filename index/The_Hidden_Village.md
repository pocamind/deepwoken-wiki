...
categories: [Pages with broken file links, Map]
---
...
The Hidden Village is a small abandoned town located in [Erisia](Erisia.md). The main way of entering is through a wooden door in the [Towerstruck Lands](Towerstruck_Lands.md) that must be broken down with a mantra or heavy weapon m3. Inside the Village are a few NPC's, Black [Mudskippers](Mudskipper.md), a bountiful amount of Erisore Nodes, and a fountain that can allow you to teleport to [Greathive Aratel](Greathive_Aratel.md) if you meet the requirements.

The NPC's in this area includes Nimea, who gives lore and information about the Lightkeepers and the village, and Cestis who can be found resting in one of the homes.

## Contents

-   [Black Mudskippers](Mudskipper.md)
-   Erisore Nodes
-   Nimea
-   Cestis
-   [Greathive Aratel Fountian](Greathive_Aratel.md)

## Quests

File:Nimea's Dialog.png

Nimea's dialog prompt upon interaction with the player.
...
Cestis' interaction dialog when talking to the player.
