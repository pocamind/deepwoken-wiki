...
### Fountain Gate Locations (To Greathive Aratel)

1.  [The Lordsgrove](The_Lordsgrove.md) - At the end of the area on a cliffs edge.
2.  [The Hidden Village](The_Hidden_Village.md) - In a corner on the right of the village.
3.  [Etris](Etris.md) - In the center of a small maze in [The King's Garden](<The_King's_Garden.md>), to the left.
4.  [Isle of Vigils](Isle_of_Vigils.md) - To the right of the bridge leading to [Friid, Master of Gale](Friid,_Master_of_Gale.md), in ruins.

### Fountain Gate Destinations (Leaving Greathive Aratel)
...
-   To gain access to the Fountain Gates to travel to [Greathive Aratel](Greathive_Aratel.md), you must use the Fountain Gate at [The Lordsgrove](The_Lordsgrove.md).
