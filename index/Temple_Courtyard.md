...
**Temple Courtyard** is a [location](Locations.md) in _Deepwoken._ It is a sub-location of the [Temple of the Forgotten Flame](Temple_of_the_Forgotten_Flame.md) found in [Upper Erisia](Upper_Erisia.md).

## Overview

The Temple Courtyard is a small courtyard that leads up to the [Temple of the Forgotten Flame](Temple_of_the_Forgotten_Flame.md). It is located above [Path's Respite](<Path's_Respite.md>). The area is similar to that of ruins.
