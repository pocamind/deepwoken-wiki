...
It's possible to interact with the shrine using [Idol of Yun'Shul](Relics.md) Relic. This will allow for one wish to be made and consume the item after usage. The item bypasses any cooldowns and doesn't require the player to posses a Resonance.
...
2.  **"My Flaws weigh me down too much, I wish for relief."**
    -   Rerolls one of your [flaws](Boons_and_Flaws.md). Has a small chance of replacing it with the [Vacant](Boons_and_Flaws.md#flaws) flaw. Can be used to get rid of the Tarnished flaw.
        -   **You can only make this wish once**, so if you get stuck with something like deficient, you can't get another reroll.
