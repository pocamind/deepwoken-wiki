...
-   There is no reason to use a Messer over a Mace since they both cost the same and maces have a block breaking critical attack. The only reason people would use a Messer is just because its a sword and they're attached to it's play style.
-   It can be alloyed. The alloyed version is better than a [Mace](Mace.md) but a regular Messer is inferior to a mace.
