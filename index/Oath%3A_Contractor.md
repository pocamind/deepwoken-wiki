...
1.  Get neutral or positive reputation with [The Ministry](The_Ministry.md). You can check your reputation at a campfire.
    -   You can either get this through [Soothsayer](Soothsayer.md) by paying him with knowledge or Imel, Emel, and Fimel's bounties if you choose, but you can also help the Ministry out in [Summer Isle](Summer_Isle.md). A good way to do this is to knock and carry one Ministry Scout, waiting for the nomads to kill the other, and then assassinate them. This is far less efficient then doing bounties, only giving around half the reputation but double the time to complete.
...
-   Upon obtaining the Oath, your reputation with The Divers will be set to Hunted. You can still gain reputation normally (such as completing Layer 2 expeditions or helping Diver NPCs) but cannot pay to restore reputation.
...
-   A Contractor that is progressing (doesn't have all moves/talents) will send their victims to Layer 2 instead of outright wiping them. This ONLY applies while they do not have 3 oath grips.
...
-   Contractor mantras used to scale off of the intelligence stat, but as of the 5/15/23 update, they no longer scale with INT. The base damage of the mantras was increased in return.
