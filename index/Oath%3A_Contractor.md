...
4.  Make a deal with 4 [Deep Shrines](Deep_Shrines.md)(Make sure to speak with [The Lord Regent](The_Lord_Regent.md) first or the shrines won't count.) Any Shrine except the **Shrine of Solitude,** **Shrine of Mastery and Shrine of Order (stat allocation)** works, including those in the [Temple of Hearts](Temple_of_Hearts.md). (As of right now using the Shrine of Mastery to re-evaluate your stats doesn't work.) You can use the same shrine multiple times and it will count.
