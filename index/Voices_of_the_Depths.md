...
The **Voices of the Depths** are encountered when the player attempts to escape [The Depths](The_Depths.md) and in the [Trial of One](Trial_of_One.md). As the name suggests, they are simply voices and cannot be interacted with. They seem to oversee [The City of The Drowned](The_Depths.md), with the few that remain there living in terror of them.
...
-   When multiple players try to escape The Depths together, it decides that the players deserve true punishment, forcing them to kill each other until it decides that the trial can finally start.
