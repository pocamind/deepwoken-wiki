...
A very common grayish-blue or sandstone ore that can be found in any cave.
...
A black ore that is found in most cave systems.
...
A grey-brownish ore that can be found in most caves.

Unlike all other Pure Ores, Pure Iron cannot be traded to a [Blacksmith](Blacksmith.md).
...
-   Every ore can be eaten with the [Termite](Talents.md#termite) Talent.
