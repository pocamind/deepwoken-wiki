...
-   Golden Fish (Very Rare, Gives 16-30% Luck) NOTE: Any fish (and trash such as seaweed) can be golden and will appear with a yellow aura when caught. Max luck from fishing is 43% (tested).
...
-   The harder the difficulty aka how fast dirrection changes the bigger the chance for chest/golden (tested)
