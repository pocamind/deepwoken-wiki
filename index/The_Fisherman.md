...
The Fisherman is a high level enemy found in [The Depths](The_Depths.md). It can spawn randomly as an event, or as a quest for [The Divers](The_Divers.md) (found on the Quest Board in [Castle Light](Castle_Light.md)/[The City of the Drowned](The_City_of_the_Drowned.md)). He uses the [Thundercall](Thundercall.md) attunement and the oath [Chainwarden](Oath%253A_Chainwarden.md), implying that he has ties to [The Central Authority](The_Central_Authority.md). He has a large pool of Health and does a decent amount of damage.

The Fisherman wears a [Grand Fisher Helm](Grand_Fisher_Helm.md) and [Grand Fisher Plate](Grand_Fisher_Plate.md), and he uses an enchanted [Halberd](Halberd.md) as his weapon.
...
| Name | Description |
| --- | --- |
| Execute | Splits the enemies head in two with their Halberd. |
...
-   Due to the fact that The Fisherman uses [Chainwarden](Oath%253A_Chainwarden.md), it is difficult and not recommended to run, because he will pull you towards him.
