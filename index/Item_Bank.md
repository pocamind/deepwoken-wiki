...
The Item Bank is a way of securely storing and transferring items on your account, even across different slots. They are accessible at any [Banker](Banker.md) (NPCs that you turn in artifacts to), or a hired Banker inside the Trophy room of the [Guild Base](Guild_Bases.md). You start off with 6 item slots which can be expanded by paying 1,000 /2500 /5000 /10000, increasing every 6 slots for a maximum slot count of 102. To store an item, drag an item from your inventory to a slot in the bank.
...
-   You cannot store the Worldpiercer Gauntlets.
