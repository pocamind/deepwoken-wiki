...
**Frostdraw** is an [Attunement](Attunement.md) that grants the user the ability to bring forth frost and the freezing cold, giving them access to abilities which focus on area denial and debuffs. Frostdraw is slightly slower compared to other [Attunements](Attunement.md), but still offers offensive options that are relatively quick and cunning. This translates to the fact that the Attunement would fit well to people who have a defensive approach to combat.

### Abilities

Landing Frostdraw [Mantras](Mantras.md) applies [Chill](Chill.md), which slows down enemies and is able to be improved upon with certain [Talents](Talents.md). Adding [Logstones](Aeon_Logstone.md) to certain Mantras can increase the duration of Chill.

## Obtainment

The Attunement can be unlocked by using a [Glassblood Potion](Attunement_Potions.md) obtained by giving [Nell](Nell.md), the Frostdraw trainer at [Etris](Etris.md), two [Frigid Prisms](Frigid_Prism.md). Nell is located in a small house to the right of the Etris Guild Hall. Alternatively, you can simply pick Frostdraw as your starting Attunement in Character Creation.
...
Frostdraw can be trained by using the [Hemafrost](Hemafrost.md) to increase the attribute after either landing Frostdraw Mantras or eating [Frigid Prisms](Frigid_Prism.md) to gain enough EXP.
...
You can speak to [Nell](Nell.md) at [Etris](Etris.md) or a [Mantra Lectern](Mantra_Lectern.md) to upgrade your Frostdraw Mantras for 100 each. Each upgrade purchased will make the next upgrade for the same Mantra 100 more expensive.
...
-   Has 6.58x PvE scaling (multiply scaled damage dealt by 6.58 for PvE damage).
...
_Impale your foes with a brutal ice barrage. Does +25% damage if enemy is airborne, or after a Crystal Knee._
...
You can spam F to get out of Freeze faster.
 ...
 |
|  | Spike Traps  
(30 Frostdraw, Ice Spikes) | Press F during the wind up of your Ice Spikes to create traps around you instead of spawning a spike in the normal spot. | You cannot have more than 4 Spike Traps, attempting to add another will cause the first one to go off. |
...
| --- | --- | --- | --- |
|  | Preceding Chill  
(60 Frostdraw, Ice Beam) | Enemies hit during the last moments of your ice beam are frozen. | Doesn’t freeze with Crystal path, instead adds another Crystal on final hit. |
...
| --- | --- | --- | --- |
|  | Glacial Mobility  
(20 Frostdraw, 20 Agility, Ice Blade) | Cast while sliding to perform a running attack with your ice sabers. | The Talent activates after you've slide jumped, and not during the slide jump, contrary to the Talent description. |
...
(40 Frostdraw) | Your ice abilities no longer grant a slow effect or the ability to freeze and instead cause ice crystals to grow on your opponent. | Your Frostdraw Mantras, Chilling Enchant, and Legendary Weapons (like [Gran Sudaruska](Gran_Sudaruska.md)) are now a reddish pink.  
...
1 second cooldown on crystal explosions.
 ...
 |
|  | Crystal Shrapnel  
(60 Frostdraw, Glass Path: Crystallization) | Your Crystal explosions now have an AoE that applies crystals to all hit. | Will also damage the target that procced the crystal explosion, increasing total damage. |
|  | Reclaimed Glass  
(65 Frostdraw, Crystal Shrapnel) | Your Crystal Shrapnel explosions now grant you and any allies caught in them 10% Elemental Resistance for 10 seconds. | Crystal shrapnel will grant you and caught allies 10% Elemental Resistance for 10 seconds.  
...
-   Frostdrawers can refer to Frostdraw attunement users such as [Eastern Nomads](Eastern_Nomad.md) on [Etris](Etris.md), [Songseeker Frostdrawers](Songseeker_Frostdrawer.md) in [Songseeker Wilds](Songseeker_Wilds.md) and [Minityrsa](Minityrsa.md), Authority Captains in [Starswept Valley](Starswept_Valley.md) and the Kyrsgarde in the [Second Layer](Second_Layer.md).
