...
The Potion Master's Hat is an [Equipment](Equipment.md) under the "Head" category.

The [Apothecary](Talents/Vow_of_Iron.md#apothecary) Talent grants 125% [Potion](Alchemy.md) potency. The [Flask Amplifier](Talents/Vow_of_Iron.md#flask-amplifier) Talent increases the healing gained from [Etris Flasks](Etris_Flask.md) by 15%. This is an additive increase to the healing that Flasks grant, increasing them from 50% health restoration to 65%.
