...
# Lost Celtor city bells

## Overview

[The Lost Celtor city](The_City_of_the_Drowned.md) bells are the bells which can be rung in order to open the gate leading to the [Cathedral of the Insterstice](Cathedral_of_the_Interstice.md), access [the Depths Trial](Cathedral_of_the_Interstice.md#east-entrance-city-bells) and escape [the Depths](The_Depths.md).
...
-   A city bell can not be rung if:
    1.  It had just been rung;
    2.  It is not making the high-pitched noise;
    3.  The gate to the [Cathedral of the Interstice](Cathedral_of_the_Interstice.md) is open.
