...
The Crucible Rapier is around the same as the [Apprentice Rapier](Apprentice_Rapier.md) and [Inquisitor's Thorn](<Inquisitor's_Thorn.md>), not having too much of a difference of the both except for higher damage and a 20% penetration stat. It can be obtained in [Starswept Valley](The_Starswept_Valley.md) as well as the [Rogue Hive Constructs](Hive_Construct.md) on [Minitrysa](Minityrsa.md).
