...
**Glazed Fish** is a craftable [Food](Food.md) item. It is also purchased from [Mess Chef](Mess_Chef.md) for 20, [Mikhail Spellhardt](Mikhail_Spellhardt.md) for 15 during [Hallowtide](<Hallowtide_(Event).md>), and [The Meat Lord](The_Meat_Lord.md) for 2, sold at random.
...
-   1 [Fish Meat](Fish_Meat.md) and 1 [Sap](Sap.md) at a [Campfire](Campfire_Pit.md) [CraftingCampfire](Campfire_Pit.md).
