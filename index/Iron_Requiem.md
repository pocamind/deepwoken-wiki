...
categories: [Weapons, Flintlocks, Legendary Weapons, "Attunement-based Weapons", Unique Critical, Weapons with Unique Criticals, Multiple Criticals]
---
...
| range | 10 |
| swing speed | 1.17x |
| special effect | Custom critical attacks that apply rods, with the base critical attack replenishing ammo aswell. |
| weight | 1 |
| bankable | Yes |
| droppable | Yes |
| enchantable | Yes |
