...
| cooldown | 1 Second (Placing) / Windup + 15 Seconds (Teleporting) |
...
**Taxi**, also referred to as _Fast Travel_, _Gate_, or _Flying Raijin_ is a [Resonance](Resonance.md) or "bell" that players can obtain and is exceedingly rare to roll.
...
Shortly after charging, all players inside **Taxi's** radius teleport to the set waypoint, appearing similar to teleportation used by [Greathive Aratel](Greathive_Aratel.md)'s fountains.

## Usage

Pressing C will activate the **Taxi** Resonance.
...
If Taxi is Drowned, you'll receive preset waypoints depending on the Luminant you're in, with the names of these waypoints having square brackets around them. The waypoint markers for these waypoints and the teleport VFX for travelling to these waypoints matches the color of your bell.
...
When obtained, Taxi will invest it's Resonance points on the following stats:
...
If Taxi is Drowned, in addition to the extra Resonance points to spend, the maximum amount of points that can be invested into the Max Markers stat is increased to 7.
...
-   In some circumstances, when attempting to teleport, you're met with the message 'something ancient is interfering with your resonance.' This occurs in some instanced dungeons and certain areas of the map, such as Duke Erisia's Manor.
    -   You are still able to use Taxi as a sort of "compass" to make waypoints and guide you on where to go on repeat runs, such as certain hard to reach medal chests in New Kyrsa, or an optimal Galewax route in the Eternal Gale.
        
    -   If you ever want to delete waypoints placed in dungeons, you can set waypoints and teleport to them within a [Ferryman](The_Ferryman.md) instanced dungeon.
...
-   Taxi charges faster if you are relatively close by the location you chose to teleport to.
-   Taxi now cancels if hit during the first 0.5s of its windup. If its windup is cancelled, it isn't put on CD
