...
-   If you have the Brain [Food Buff](Status_Effects.md#food-buff) from the [Grilled Parasol Brain](Grilled_Parasol_Brain.md), Might Gem's posture damage modifier will be increased from +10% to +15%.
-   The Might Gem can gain additional effects and more potency on its posture damage buff through the equipment Talents on the [Ascended Outlaw Set](Ascended_Outlaw_Hat.md).
    ...
    -   The [Stronger Under Pressure](Talents.md#stronger-under-pressure) Talent from the [Ascended Outlaw Breeches](Ascended_Outlaw_Breeches.md) additionally applies a slowing debuff to your opponent when you land a Mantra with a Might Gem equipped. The effectiveness of the slow scales on the amount of player combat tags you have.
...
-   [Equipment](Equipment.md): [Ascended Outlaw Hat](Ascended_Outlaw_Hat.md), [Ascended Outlaw Robes](Ascended_Outlaw_Robes.md), [Ascended Outlaw Boots](Ascended_Outlaw_Breeches.md), and [Ascended Outlaw Mask](Ascended_Outlaw_Mask.md).
