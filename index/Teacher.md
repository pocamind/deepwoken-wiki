...
The Teacher spawns along with 2 more NPCs sitting next to a campfire with set races and features (one being an Adret, the other unconfirmed), two of which wield powerful modified [Frostdraw](Frostdraw.md) mantras. They seem to be hostile on-sight towards the Authority and Etrean Guards.
