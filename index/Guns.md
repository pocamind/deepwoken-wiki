...
There is no INT requirement, although it is recommended to have quite a bit since guns use ether if you have no bullets (Bullets cost 5 notes each or can be crafted anywhere using 1 iron).
