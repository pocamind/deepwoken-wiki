...
1\. You must save [Epsi](Epsi.md) in [Floor 1](Second_Layer/The_Ethironal_Shrine.md) of the [Second Layer](Second_Layer.md) of [the Depths](The_Depths.md) and report to [Alpha](Alpha.md) afterwards.

2\. Alternatively, you can also complete the [Summer Goons](Orion.md) quest and return to Orion to obtain the Origin.
...
-   _In-game description_: A card representing your membership in the Ignition Union. Entitles you to speedier experience gain from Dungeons and Jobs, though the fees will slightly reduce your experience gain outside of these.
-   This [talent](Talents.md) increases your EXP gain from completing [Jobs](Job_Boards.md) and [Dungeons](Dungeons.md), however decreases your EXP gain from everything else.

### Union Pager

-   _In-game description_: Check up on job listings remotely.
-   A portable job board that allows you to check on and take jobs anywhere on the map. Proves useful in [Celtor Wastes](Celtor_Wastes.md), since there are only two job boards placed on both entrances to [The City of the Drowned](The_City_of_the_Drowned.md).
