...
| enchantable | Yes |
| pass down | Yes |
| obtainment | Chests From:, Starswept Valley, Primadon (Gem chest), Golem Constructs |
...
-   This weapon was originally hidden from testers, explaining how OP it was on release.\[citation needed\]
...
-   The M1s used to have the same animations as the [Wyrmtooth](Wyrmtooth.md) and [Railblade](Railblade.md), but this was changed on April 19th, 2024.
...
-   The sliding critical slashes doesn't match the animations.
