...
| swing speed | 0.93x |
| penetration | 15% |
| special effect | Spawns green flames on hit. |
...
-   **Lifelord's Blaze:** M1 attacks spawn green-yellowish flames on hit, this is completely cosmetic. This has a 4 second cooldown before it can proc green flames again.
...
**Crouching:** Performs the normal critical, but sped up significantly. (Having the [talent Cap Artist](Talents.md) will make this unusable as the talent effect gets you to be knocked.)
...
-   It is the weapon with the most different stat requirements, being Heavy, Flamecharm and Light.
    -   Ysley's Pyre Keeper also having 5 different criticals effectively renders it the most complex weapon in the game, especially in combination with how uniquely it scales with Light.
        -   This also makes it have the highest amount of criticals ingame.
