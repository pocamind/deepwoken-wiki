...
| enchantable | Yes |
| pass down | Yes |
| obtainment | Chests From:, Starswept Valley, Primadon (Gem chest), Rogue Construct |
...
Ysley's Pyre Keeper has five different criticals: Normal, Aerial, Crouching, Running, and Sliding **Aerial**: Does 2 followup attacks, first one burns and puts you to the ground (similar like the Greathammer or -axe critical) and second ragdoll flings you while erupting the ground, removing the burn effect. While blocking the second attack, you get guardbroken.
