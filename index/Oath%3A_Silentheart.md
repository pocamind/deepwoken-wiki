...
“ How am I bad? I'm using a fair oath! ”

― Silentheart user explaining how they skillfully won a chime match after running around with ankle cutter and vengeful pursuit.

## Description

**[Oath](Oaths.md): Silentheart** is one of the 12 obtainable Oaths in _Deepwoken._ It sacrifices [Mantras](Mantras.md) and [Attunements](Attunements.md) as a whole in exchange for significantly higher damage and a unique set of attacks integrated into your moveset.
...
-   **Vengeful Pursuit - Passive**
    -   Your running attacks that miss send out a mid-range crescent projectile that slows on hit.
        -   Light and medium weapon guns cannot proc Vengeful Pursuit
        -   8 seconds cooldown.
