...
-   It's Eyebeam passes through obstacles if it's chest is close enough to the wall, and has a blast radius, so don't feel safe if you hide from it above it on a hill or something. The best way to evade this move is to wait for it to charge up and roll away when its about to fire. You can notice that by hearing how sounds of charging stops, after that it shoots.
