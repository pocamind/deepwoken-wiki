...
**Rock Golems** (also referred to as Golems, or Erisian Golems) are large, bulky stone constructs with a distinct, glowing, white core, and three peculiar stone discs on their "stomach" and "kneecaps." Their bodies look as though they're fragmented, but they remain intact regardless.
...
-   **Rapid Spin** - Hit 3 times during the windup, before either dodging back and running away from the attack (safe, but loses you the 2 hits after barrage) or parrying the barrage (risky, but allows you to get the 2 hits).
    -   **Lethal Spin (Prime Golem)** - You can parry the Spin by spamming F but the risk is far greater.
