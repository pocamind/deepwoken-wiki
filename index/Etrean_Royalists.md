...
“ Greetings, traveller. Don't cause any trouble on the clan grounds. ”

― Royalist Guard

## Description

The Etrean Royalists, also known as the Old Guard, are a group of [Etreans](Etrean.md) belonging to the various ancient clans that make up the Old Guard of [Etrea](Etrea.md) who were respected before [The Lord Regent](The_Lord_Regent.md)'s coup, being now treated as 'a gaggle of rebellious lords, - or worse, 'scheming usurpers' thanks to the Regent's mind veil over the people of [Etris](Etris.md). They appear exclusively in the [Vow of Iron](Vow_of_Iron.md) mode and are working alongside the [Circle of Honour](Circle_of_Honour.md) to take down [The Lord Regent](<Zi'eer,_the_Fourth_Prophet.md>).

The Royalists are made up of four distinct clans: [Clan Anako](Clan_Anako.md), [Clan Mofisu](Clan_Mofisu.md), [Clan Kobura](Clan_Kobura.md) and [Clan Ganba](Clan_Ganba.md). They are all led by their respective 'Sachans' or Clan Leaders: [Yi Anako](Sachan_Yi_Anako.md), [Choji Mofisu](Sachan_Choji_Mofisu.md), [Shisui Kobura](Sachan_Shisui_Kobura.md) and [Zaru Ganba](Sachan_Zaru_Ganba.md).
...
Following a heated argument between each of the Sachans at [The Golden Rat](The_Golden_Rat.md), the Old Guard was effectively disbanded leaving each clan alone to their own plans. [Clan Ganba](Clan_Ganba.md) wished to make contact with the [Isle of Vigils](Isle_of_Vigils.md) and use it as a base of operations against the Lord Regent, and if not possible, make their way westward and attempt to join with [The Hundred Legions](The_Hundred_Legions.md). They also wished to retake the Monastery of Mur and the Viridian Sanctuary to which [Clan Mofisu](Clan_Mofisu.md) and [Clan Anako](Clan_Anako.md) were 'adamant' about.

On the other hand, [Clan Kobura](Clan_Kobura.md) wanted to join forces with [The Central Authority](The_Central_Authority.md) claiming they needed 'powerful allies against the Regent' or even join the Regent's forces if no other solution presented themselves.

## Reputation

Every [Memento](Mementos.md) regardless of [Aspect](Aspects.md) starts with Neutral Reputation with the Royalists. Their reputation is shared across every clan meaning doing the jobs of a single clan will raise it for the entire faction.

There are only a few ways to gain reputation with the Royalists:

-   Talking to [Seon](Seon.md) or [Kazue](Kazue.md) and picking the only dialogue option will increase your reputation slightly, and it can only be done once per character.
...
-   [Sachan Yi Anako](Sachan_Yi_Anako.md)
