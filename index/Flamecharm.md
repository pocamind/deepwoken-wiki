...
The [Attunement](Attunements.md) can be unlocked by using a [Hearthblood potion](Attunement_Potions.md) obtained in the [Songseeker Wilds](Songseeker_Wilds.md) using five [Dying Embers](Dying_Embers.md) (two if already obtained), and can upgrade spells for 100 Notes each. Each upgrade purchased will make the next upgrade for the same mantra 100 notes more expensive. It costs a total of 1000 Notes to fully upgrade a mantra
