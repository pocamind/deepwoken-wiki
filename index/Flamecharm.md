...
-   Certain Mantras are similar to Pyromancies and similar attacks from games created by _**From Software**_, a large inspiration for Deepwoken.
    ...
    -   Flamecharm is the best for depth’s grinding as it has a talent called «Undying Flames» which makes the users flames work in the depths and Flamecharm have a ability (Flame of denial) wich resets some sanity upon use.
