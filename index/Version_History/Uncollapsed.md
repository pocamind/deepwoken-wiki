...
• Encircle CD increased (9s -> 10s) • Increased Needle Barrage base damage per needle (2 -> 4), needles now apply a brief stun if they hit. Damage with upgrades scaled down to adjust  
...
•Fixed Astral projectile not scaling. Note that this projectile is on top of the existing +20% dmg in PvE that Astral provides (credit to Lulux44 for the anims on the new LW btw!)  
