...
**Content & System**  
• New [Ironsing](../Ironsing.md) [Mantra](../Mantras.md): Iron Quills  
• New [STR](https://deepwoken.fandom.com/wiki/Attributes#Strength)/[AGL](https://deepwoken.fandom.com/wiki/Attributes#Agility) Talent: [Going Nowhere](https://deepwoken.fandom.com/wiki/Talents#Pursuer)  
• Added [Enchant Grease](../Enchant_Grease.md); a powerful oil coating capable of enchanting your [Equipment](../Equipment.md)  
• The [Shrine of Mastery](https://deepwoken.fandom.com/wiki/Deep_Shrines?so=search#Shrine_of_Mastery) now offers you the ability to reallocate up to 3 [attribute](../Attributes.md) points to correct accidental investments you've made. Unlike the [Shrine of Order](https://deepwoken.fandom.com/wiki/Deep_Shrines?so=search#Shrine_of_Order), this cannot be used to bypass requirements. Note that if you have used the Shrine of Order this point reallocation may not be possible, as it doesn't allow you to use it if you would not meet the requirements for your [talents](../Talents.md)/[weapons](../Weapons.md)/equipment after  
• You can now purchase multiple [Yun'Shul](<../Shrine_of_Yun'Shul,_Keeper_of_Hearts.md>) wishes from [Miserables](../Misérables.md) at a time, though [the costs](https://deepwoken.fandom.com/wiki/Knowledge?so=search) will increase each time depending on how many you have stored ()  
• [Chrysid](../Chrysid.md) [Starkindreds](../Oath%253A_Starkindred.md) now sprout moth wings  
• [Vesperian](../Vesperian.md) and [Ganymede](../Ganymede.md) Starkindreds now sprout beetle wings  
...
• [Enchant Stones](../Enchant_Stone.md) now have the visuals of their corresponding [enchants](../Enchantments.md)  
• Enchant Stones are now sorted into the [Relic](../Relics.md) category in your inventory  
• Boulder Climb has been merged into [Kick Off](https://deepwoken.fandom.com/wiki/Talents#Acrobat). If you had Boulder Climb you'll get a hand of talents refunded to you  
  
**Pyre Keeper Remodel**  
• [Ysley's Pyre Keeper](<../Ysley's_Pyre_Keeper.md>) has received new models for both the sword and the dagger  
...
**Balancing & Tweaks**  
• [Klaris](../Klaris_Llfiend,_Mother_of_Lights.md) now sells Enchant Grease instead of giving your equipment a random enchantment  
• [Laplace](../Laplace.md) now sells Enchant Grease  
• [Shrine of Division](https://deepwoken.fandom.com/wiki/Deep_Shrines?so=search#Shrine_of_Division) [Knowledge](../Knowledge.md) cost reduced (10 -> 5)  
• [Lightning Attuned](https://deepwoken.fandom.com/wiki/Monsters?so=search#Attunement_Types/Effects) [mobs](../Monsters.md) no longer have the chain lightning trait  
• Lightning Attuned mobs only proc [Shock](https://deepwoken.fandom.com/wiki/Status_Effects?so=search#Shocked) on damaging moves  
• Buffed [Primadon](../Primadon,_Titan_of_the_East.md) relic drop rates  
• Buffed [Etris Raid](../Cinders_of_Etris.md) relic drop rates  
• Reduced [Chainlash](https://deepwoken.fandom.com/wiki/Oath:_Chainwarden#Abilities) initial windup (1s -> 0.7s), reduced endlag (0.3s -> 0.1s). Chainlash's followup hit can now connect as soon as they're in range  
• [Audacity](https://deepwoken.fandom.com/wiki/Talents#Tyrant) ally buff duration increased (10s -> 15s)  
• Reduced [Ice Beam](https://deepwoken.fandom.com/wiki/Mantras/Mantra_Gifs#Frostdraw) endlag (0.3s -> 0.15s), increased windup (0.3s -> 0.35s), increased base width  
• [Gravity Bell](../Gravity_Field.md) High Gravity variant now has a reduced duration  
• [Anklets of Alsin](../Anklets_of_Alsin.md) now has a req (25 LHT)  
• Storm Cages now destroy other Storm Cages in their radius  
• Parrying [Flame Repulsion](https://deepwoken.fandom.com/wiki/Mantras/Mantra_Gifs#Flamecharm) no longer knocks you back  
• Greatly reduced knockback from parrying [Kyrsan](../Kyrsgarde.md) spears  
• Reduced climb boost of Boulder Climb's effect that has now been merged into Kick Off  
• [Capra](../Capra.md) Marks now have visible CD's  
  
**Bugfixes & Optimization**  
• Fixed pulling a fast one on [Korin](../Korin.md)/[Drefa](https://deepwoken.fandom.com/wiki/NPCs)  
• Fixed dungeons having overly high [ingredient](../Ingredients.md) spawn rates  
• Fixed summoning [Dread Serpent](../Dread_Serpent.md) outside of the [Voidsea](../Voidsea.md)  
• Fixed [Gigamed](../Gigamed.md) Extermination event being listed improperly on [job boards](../Job_Boards.md)  
