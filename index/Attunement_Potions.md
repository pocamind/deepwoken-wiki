...
The only way to acquire an Attunement Potion is to complete a quest given by the relevant [Spelltrainer](Attunement_Trainers.md), this quest usually involves obtaining 5 of a specific Elemental Ingredient; with [Ironsing](Ironsing.md) being the only deviation from this.
