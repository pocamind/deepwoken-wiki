...
| Dimensional Travel | |
|---|---|
| effect | Teleports the player into another realm which scales with the map but using 10 times might get u banned |
...
-   **Use in combat:** If this stat is used, this resonance can be used while in combat. Will deduct a large amount of points.
    -   If Dimensional Travel is drowned, this stat is guaranteed.
