...
categories: [Weapons, Swords, Katanas, Weaponry, Items]
---
...
The Shattered Katana is an endgame [Medium Weapon](https://deepwoken.fandom.com/wiki/Weaponry#Medium_Weaponshttps://deepwoken.fandom.com/wiki/Weaponry#Medium_Weapons) and is a very effective one to use as a [Medium Weapon](https://deepwoken.fandom.com/wiki/Weaponry#Medium_Weapons) user. It is a somewhat rare drop from chests in high leveled locations like the [Starswept Valley](The_Starswept_Valley.md), or [The Depths](The_Depths.md). The Shattered Katana has 20 Base Damage and a scaling of 7 so it deals 34 damage at 100 MED. It also comes with a 25% Penetration stat, a very good stat to have as only a handful of weapons in the game include this stat on them.

The Shattered Katana across various updates has been nerfed and is debatably, no longer the best [Medium Weapon](https://deepwoken.fandom.com/wiki/Weaponry#Medium_Weapons). The addition of the [Pluripotent Alloy](Pluripotent_Alloy.md) has made weapons such as the [Shotel](Shotel.md) or [Vigil Longsword](Vigil_Longsword.md) an easier option and in some aspects better weapon than the Shattered Katana when [alloyed](Pluripotent_Alloy.md).
