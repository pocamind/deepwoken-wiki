...
Grants the user the "[Grotesque Resilience](Talents.md#miscellaneous)" Unique Equipment Talent, which reduces all damage from "Damage Over Time" effects by 50%, which also stacks with other DoT effects.
