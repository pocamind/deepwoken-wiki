...
Grants the user the "[Grotesque Resilience](Talents.md#miscellaneous)" Unique Equipment Talent, which reduces all damage from "Damage Over Time" effects by ~66% (2/3).
