...
You can converse with the Watchers if you are wearing the [Sworn](Sworn_Angel_Mask.md) or [Hollow Angel Masks](Hollow_Angel_Mask.md). Due to the Angel Mask Talent, [Angel's Guise](Talents.md#equipment-talents), the Watcher believes that you are one of its angels. This is important for context.
...
-   The Watcher at the Temple of the Forgotten Flame can be damaged by bloodcurdle, but after sustaining around 9% of its total health it will disable any mantras that were attempted to be cast within its range. making bloodcurdle go into a infinite cooldown, further testing is needed.
