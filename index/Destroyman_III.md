...
-   The line “HINT: If you can't solve a puzzle and have to use the wiki, you are foolish and I will laugh at you. As a friend. Like, in a friendly way.” is a reference to the wiki! The one you’re on right now! (Wow.) This was the first ever public acknowledgment of the wiki prior to it being declared official. (The apparent puzzle seems to be a reference to the library puzzle in [New Kyrsa, The Sleeping City](New_Kyrsa,_The_Sleeping_City.md) and the puzzle in [The Birdcage](The_Birdcage.md))
...
-   The line "Journey before destination." is the same as the, now removed, [Jetstriker](Jetstriker.md) [Mystic](Mystic.md) dialogue.
