...
-   Like other major factions, they seem to be based on a real-world culture, with Etrea being based on East Asian countries like Japan and China.
...
-   You used to be able to gain Reputation with Etrea from beating the [Blade Instructor](Blade_Instructor.md) enemy, but this is no longer possible with the introduction of [Training Mode](Training_Mode.md) having completely removed it.
