...
| obtainment | Finding a Deferred enchanted weapon in a chest, LaplaceDeferred Enchant Stone:, Exchanging 5 to Klaris (grants a random non-exclusive Enchant Stone), War Mode, Hell Mode, Scion of Ethiron, Maestro Evengarde Rest, Dread Serpent, Heart of Enmity, Chaser, Scholar of the Crimson Contract, Saramaed Hollow, Second Layer, Diluvian Mechanism, Galewax Room in the Second Layer, Crafting :, Any Enchant Stone, Irithine, Blessed Gem, Any Enchant Stone, Aeon Logstone, Blessed Gem |
