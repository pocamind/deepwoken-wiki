...
Light's Final Toll is a Legendary spirit lantern that floats beside the player. The player also wears a string of prayer beads around their arm. It can be obtained from both floors of [Layer 2](Second_Layer.md). It is currently the only weapon to scale off of Willpower.
