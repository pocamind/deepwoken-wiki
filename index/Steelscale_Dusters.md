...
| penetration | 20% |
| talent | Swiftscales - Fang and Coil's base critical gains a small buff to its speed, range and endlag. |
| m.equip | No |
| m.extract | No |
| stances | 1 Handed |
| rarity | Rare |
...
| enchantable | Yes |
| pass down | Yes |
| obtainment | Maestro Evengarde Rest, Interluminary Parasol, Fishing, War Mode, Cinders of Etris, The Doom of Caeranthil |
...
Steelscale Dusters uses the default Fist critical, a showing of martial prowess that changes depending on the user's equipped [Fist Style](Fists.md#styles).
