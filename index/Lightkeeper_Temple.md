...
**Lightkeeper Temple** is a seemingly abandoned temple, occupied by many [Threshers](Thresher.md). (there are actually not that much, only 4 excluding king one) It serves as a place for players to wash their face in order to open the gate at [Starswept Valley](The_Starswept_Valley.md) and access the fountain teleports in [The Lordsgrove](The_Lordsgrove.md), [Greathive Aratel](Greathive_Aratel.md), behind the [King's Garden in Etris](Etris.md) and [The Hidden Village](The_Hidden_Village.md).
...
-   Washing your face will cause the Hive Gate to be opened for your character. Having access to [Lordsgrove](The_Lordsgrove.md), and use the fast travel point to [Greathive Aratel](Greathive_Aratel.md), ~if you have an oath~ False. You can wash your face, open the hive door, and use shrines without an oath(Tested by me obtaining visionshaper). There are rumors that you can stop aging as a 1/3 chance, but it is most likely false.
