...
The Familiar Priest's Helm is an [Equipment](Equipment.md) item under the "Head" category. It is very rare due to being an event item.

## Trivia

-   Considered one of the Best Head [Equipment](Equipment.md) pieces, due to being one of the 6 helmets that are able to reach 30 HP. The other 5 being: [Silver Knight's Helm](<Silver_Knight's_Helm.md>), [Blacksteel Helm](Blacksteel_Helm.md), [Familiar Heretic's Helm](<Familiar_Heretic's_Helm.md>), and [Familiar Knight's Helm](<Familiar_Knight's_Helm.md>) and [Khan Helmet](Legion_Helmet.md).
