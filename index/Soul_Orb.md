...
A Soul Orb has a low chance to drop from any [Enemy](Enemies.md) or [Monster](Monsters.md), with a higher chance to spawn from monsters. They will not drop from players and seem to have the same chance of obtainment on all humanoids.

## Trivia

-   Prior to the release of Verse 2, they used to grant [Luck](Luck.md).
