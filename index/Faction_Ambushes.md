...
Faction Ambushes are an event that can occur nearly anywhere in the overworld (besides towns and at sea). They occur when a player has the Hunted status or worse (-150 rep or below) with a faction.
