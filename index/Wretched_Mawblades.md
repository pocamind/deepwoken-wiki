...
The **Wretched Mawblades**, are a pair of heavy greatswords exclusive to [Hallowtide](Hallowtide.md).
...
-   Shortly after release, this weapon became infamous for doing hilariously high amounts of damage with its Critical Attack when Guard Breaking another player if enchanted with the [Stone](Stone.md) enchantment, enough to one shot players. This was confirmed to be a bug, and was promptly fixed on the [November 9th, 2024](Version_History/2024.md#november-9th-2024) hotfix.
-   Similarly to the [Ysley's Pyre Keeper](<Ysley's_Pyre_Keeper.md>), this weapon had a unique name when viewed in a [Campfire Pit](Campfire_Pit.md) UI, being "Canary Rephika & Grimlock Narsus." These are very likely the names of the people who were turned into this abomination of a weapon.
    -   Rephika is a [Chrysid](Chrysid.md) Surname, and Narsus is a [Khan](Khan.md) Surname.
