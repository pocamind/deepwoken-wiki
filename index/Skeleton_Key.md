...
Not to be confused with the [item](<Skeleton_Key_(Item).md>).
...
Skeleton Key is a [Resonance](Resonance.md) that players can obtain and is uncommon to roll.
...
If Skeleton Key is corrupted, a third wall type can be rolled. When used, your wall is 500% larger. The massive variant can stack with the spiked variant.[\[1\]](#cite-note-1)
