...
Template:Creature Info Box v2 The Legion Captain is a Humanoid NPC which appears to wear the [Legion Centurion](Legion_Centurion.md) outfit, Khan Boots, Khan Helmet and Khan Pauldrons. It has 2 "variants", One that attacks on Sight, Dubbed the Javelin Captain and a Neutral/Friendly one that appears to fight the Authority Commander. These encounters are exclusive to [Starswept Valley](The_Starswept_Valley.md).Template:Creature Info Box v2

### Moves

-   **Different Weapons:** Fast Normal M1 hits with Swords, Spears and Fists.

-   **The Friendly Captain uses moves from both Galebreath and Attunement-less:** Rising Wind, Heavenly Wind, Gale Lunge, Strong Left, and Rapid Punches.
-   The other Commander uses Grand Javelin with Grand Skewer, **this is not the captain.**
...
-   The Legion Captain, after killing the Adret, instantly aggravates on the nearest enemy NPC, doesn't matter if it's through a wall, k**illing the NPC will most probably make the Captain despawn** if it doesn't have anymore targets, Therefore, you will not be able to talk to them.
...
-   ~It is possible that your rep with the Legion is negative when you start a new character until you 1-up your rep with them, like helping a centurion in a legion vs adret event once,~ Your starter rep with the legion is actually "negative"/Neutral, they use the negative rep text but wont attack you.
