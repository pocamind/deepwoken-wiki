...
(★★☆)
 ...
 | The Enforcer lifts its weapon high and swings it down.
...
(★★☆)
 ...
 | The Enforcer puts its weapon to its side, and swings it horizontally in a swiping motion.
...
(★★☆)
 ...
 | The Enforcer begins to spin rapidly from the waist-up while holding its weapon out, walking towards the closest opponent (fairly slowly) to cut them apart.
...
-   This attack is typically used at the start of the fight, or if the player **runs too far away**.
...
-   Mantras with a long wind up and no hyperarmor are not recommended as the enforcer is very likely to interrupt it, although certain mantras may break the enforcers Ai making it turn its back on the player essentially allowing for a safe kill.
...
-   Enforcer's Eye, Giant Femur and Dread Serpent's Tooth are the only [Monster Mantra Drops](Monster_Mantras.md) to have boosted drop rates out of the other mobs that have one.
