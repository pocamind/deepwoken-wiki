...
Generally, it is recommended for you to to buy the [**Hallowtide '22, '23, '24, and '25 Medals**](Seasonal_Medals.md#hallowtide) and the _Hallowtide Aspect Variants_ first, as the all the yearly medals will allow you to unlock Hallowtide-exclusive weapons and equipment with knowledge later _**after the event is over**_. Which also includes the [Harrowing](Harrowing.md) enchantment, [Pumpkin Pitch](Pumpkin_Pitch.md) mantra, and the [Spectral Instrument Set](Instruments.md#spectral-instruments).
...
-   [Lysander Spellhardt](Lysander_Spellhardt.md): Sells you Hallowtide-exclusive [equipments](Equipment.md) and [Outfits](Outfits.md), _Hallowtide aspect Variants_, and yearly [**Hallowtide Medals**](Seasonal_Medals.md).
    ...
    4.  For **100 Joy**: You can buy random [Relics](Relics.md). All chances for any relics are the same.
...
-   [Galpin Spellhardt](Galpin_Spellhardt,_Musicologist_Extraordinaire.md): Sells you a Hallowtide-exclusive [Instrument](Instruments.md) skin, the [_Spectral Instrument Set_](Instruments.md#spectral-instruments), and some [Shanties](Books.md).
    ...
    2.  For **50 Joy**: You can buy a [Shanty](Books.md) that sings about the [Lightborn](Lightborn.md) aspect: A Light In The Sky. (Not hallowtide-exclusive, can be found in book shelves at a rare chance.
