...
Generally, it is recommended for you to to buy the [**Hallowtide Medals**](Seasonal_Medals.md#hallowtide) and the _Hallowtide Aspect Variants_ first, as the all the yearly medals will allow you to unlock Hallowtide-exclusive weapons and equipment with knowledge later _**after the event is over**_. Which also includes the [Harrowing](Harrowing.md) enchantment, the [Pumpkin Pitch](Pumpkin_Pitch.md) mantra, and the [Spectral Instrument Set](Instruments.md#spectral-instruments).
