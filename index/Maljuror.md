...
|---|---|
| health | ~2000 |
| drops | Sparks, Kindred Edict, Maljuror Jougs, Maljuror Choker |
| weapon | Kindred Edict |
| moves | Assault, Critical, Fire Blade, Flaming Scourge, Hollow Embrace |

## Description

Maljuror is a [random encounter](Random_Encounters.md) in the [Ancient Rotlands](Ancient_Rotlands.md), which drops the [Kindred Edict](Kindred_Edict.md), [Maljuror Choker](Maljuror_Choker.md), and [Maljuror Jougs](Maljuror_Jougs.md) with a small chance.
...
-   The prefix 'Mal-' means bad or ill, and a juror is someone who takes an oath, combining these gives you 'Bad Oath taker', or simplified to 'Oathbreaker'.
-   Malijurors became like this because of Ichor's rejection, in result of them "losing faith and falling into sin, punished by divinity within them that twisted them into wretched beasts."[\[1\]](#cite-note-samael-1)

## References

1.  [↑](#cite-ref-samael-1-0) [Samael](Samael.md)
