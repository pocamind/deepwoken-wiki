...
-   This weapon has the highest posture damage in the game.
    -   With the base 13 weight, [Murmur: Ardour](Murmur.md#murmur-ardour), the talent "[Heavy Hitter](Talents.md#colossus)," the two-handed stance, a [Heavy Hands Ring](Equipment.md#rings), and the [Stone](Enchantments.md#list-of-enchantments) enchantment, you can do around 34 posture damage per M1.
    -   While using the previously stated modifiers along with Ardour Scream and a 3\* Weight version of the weapon, you are able to posture break Maestro Evengarde Rest's posture with every m1, allowing for extremely quick runs. Although, Providence Thorns is generally faster.
...
-   Meeting the requirement of HVY, the damage is (39.2)
-   At max HVY, the damage is (43.6).
