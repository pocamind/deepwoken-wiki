...
Mineskippers are a Mudskipper variant that wear mining helmets and the [Experienced Adventurer outfit](Outfits.md). Their regular variant holds a pickaxe in its right hand. They are found in the [Songseeker Wilds](Songseeker_Wilds.md). They drop every [Ore](Ores.md) variant, including Erisore, Irithine, Astruline, Umbrite, Gold, Iron, and Coal. While also dropping [Miner's Hardhat](<Miner's_Hardhat.md>) which gives you the talent "Rock Blaster" which "Doubles your ore yields when mining."
