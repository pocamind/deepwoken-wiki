...
There are 2 types of these normal Mudskippers. One that can be found naturally, and one that can only spawn during the [Mudskipper Emergence](Random_Encounters.md#mudskipper-emergence) event. Which only happens in [Lower Erisia](Lower_Erisia.md) and [The Depths](First_Layer.md).
