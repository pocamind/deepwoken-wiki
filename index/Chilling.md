...
After landing enough M1s, Chilling applies [chill](Status_Effects.md#chill) and [Bottom Freeze](Status_Effects.md#bottom-freeze) to your opponent. If you have Crystallization Path, this enchantment will apply 1 Crystal when you reach its hit count instead. Once this happens, Chilling will go on a 14 second cooldown, preventing stack gain without disabling the damage Chilling does.
