...
| Oath:  Soulbreaker | |
|---|---|
| oath_req | Any Murmur, A Resonance (dependant), High Ally rep with Etrea (dependant), A sum of 50 points in Charisma and Willpower (CHA + WLL ≥ 50) |
...
-   Talk to [Theadre](Theadre.md) about the King of Etrea being a god. (must have a high ally reputation first and [Murmur](Murmur.md))
...
This Oath can be progressed via making deals with [Deep Shrines](Deep_Shrines.md) or making wishes with the [Shrine of Yun'Shul, Keeper of Hearts](<Shrine_of_Yun'Shul,_Keeper_of_Hearts.md>). You will need to make a total of 5 deals or wishes to complete the Oath's progression.
...
All of these Talents are obtained with the Oath. These are the base Murmur Talents and their child Talents with almost no differences.

-   **Murmur: Ardour** - An application of your Soul Murmur that enables one to channel the murmur into raw strength. Press H.
...
-   **Ardour Scream** - Amplify your shout into a scream using Ardour, dominating weaker foes, Victims take 25% more damage and 50% more posture damage for 10s. (+9 Sanity).
...
-   **Murmur: Tacet** - An application of your Soul Murmur that enables the user to suppress their own murmur. Press T while crouched.
...
-   **Murmur: Rhythm** - An application of your Soul Murmur that enables the user to perceive the subtle murmur emanating from all things. Press G while crouched.
    ...
    -   Red = Low Health, Yellow = Moderate Health, Grey = Healthy/Full Health
    -   **Disabled on players with Not a Scratch.**

-   **Spotter** - Marking enemies while in Rhythm will now indicate their health status to your allies.
...
-   **Soul Infusion** - Infuse Ardour into your executions. If your execute is interrupted, the opponent remains down for a longer amount of time. Your Ardour Screams are projected further.
    ...
    -   Massively increase the range of Ardour Scream from 95 studs to 200 (+105 studs). Great for combat tagging multiple people at once.
    -   Can be used in combination with the Ascended Outlaw Mask to make your Ardour Scream go to an immense 300 studs.
