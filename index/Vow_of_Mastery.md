...
_Has no range limit but struggles to be seen after a good distance._
...
| Run | Yes, 35 Charisma | "_\[Name\]_, run" | Forces the Subject to run for around 15 seconds, giving a speed boost.
 ...
 | 2 minutes |
| Fight | Yes, 50 Charisma | "_\[Name\]_, fight" | Gives the Subject a purple aura and a boost in damage and defense for 17.5 seconds. Also seems to increase attack speed. | 3 minutes |
...
-   All commands excluding _Leech,_ _Return_, _Sacrifice_ and _Live_ have no maximum range, and can be issued from any point on the map.
