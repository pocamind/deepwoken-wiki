...
**Murmur: Ardour**, commonly referred to as "Buso Haki" or just "Haki" is a Murmur that when active, doubles all outgoing posture damage and reduces incoming posture damage. Activating the Murmur will release gentle purple particles from your weapon and will make a quiet hum as long as it is active. While having the Murmur active, you can't crouch and listen until you deactivate it or the Murmur runs out (if you're not at Power 20).
