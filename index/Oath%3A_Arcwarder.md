...
**[Oath](Oaths.md): Arcwarder** is one of the 11 obtainable Oaths in _Deepwoken_. It heavily focuses on defense. 4 of its passives are defensive, the other 2 are mobility, and Arc Wave, its only Combat [Mantra](Mantras.md) other than Arc Beam is a zoning tool.
...
Arcwarder Passives and Mantras are obtained via defeating either [Chaser](Chaser,_Scholar_of_the_Crimson_Contract.md) or the [Scion of Ethiron](Scion_of_Ethiron.md), one Passive/Mantra is granted per kill until the Oath is fully progressed.
...
This Oath grants 1 Wildcard Mantra Slot and 2 Combat Mantra Slots. As for appearance, ~it overwrites the user's current eye color and grants them orange eyes instead.~ (it doesn't)
