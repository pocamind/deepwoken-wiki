...
-   You'll be unknocked and healed to 100% (so will the person attacking you)
-   Your Blood, Thirst and Hunger are maxed out.
-   A visual effect will play around you.
...
-   [Dread Serpent](Dread_Serpent.md) (Not recommended as a primary source, as his spawn rate is exceptionally low. However, does give a lot of bell progression.)
...
-   [Blizzard Knights](Stone_Knight.md#blizzard-knight) (Not recommended for infrequency, high risk, and low amount of Progress granted.)
...
Every time you use a wish, Yun'Shul goes on cooldown for a certain amount of time. It's not a level requirement, literally confirmed by arch\_mage

File:Arch says Wishes have cooldowns.png

542.988x542.988px

and it doesn't make sense for an end-game ability. However, even with the cooldown, there is a maximum amount of times someone can reroll per slot, likely 3 but need confirmation. (**This is most likely false, this needs more testing**)
