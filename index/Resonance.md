...
You can also obtain a **Resonance** from a very rare event in the overworld called the "Resonant Dawn Meteor." This meteor can appear in [these](The_Starswept_Valley.md) [few](Summer_Isle.md) [locat](Minityrsa.md)[ions](Voidsea.md) and will be protected by a [Star Knight](Stone_Knight.md). Once it is defeated, the meteor can be interacted with to obtain a random **Resonance**.
