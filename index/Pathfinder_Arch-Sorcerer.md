...
| Pathfinder Arch-Sorcerer | |
|---|---|
| caption | Robes of a full fledged Pathfinder Sorcerer. Grants excellent elemental defense and Ether regen. |
| tier | Expert |
| crafting_req | x5 Cloth, x5 Fiber, x10 Irithine, x1 Lionfish Scale, x1 Strange Claw |
| price | 100 |
| stat_req | Power 10, 25 Intelligence |
| bankable | Yes |
| droppable | Yes |
| durability | 1500 |
...
**Pathfinder Arch-Sorcerer** is an Expert [Outfit](Outfit.md) in _Deepwoken_.

## Statistics

### _Requirements_

This Outfit costs 100 and requires five (5) [Cloth](Cloth.md), five (5) [Fiber](Fiber.md), ten (10) [Irithine](Irithine.md), one (1) [Lionfish Scale](Lionfish_Scale.md), and one (1) [Strange Claw](Strange_Claw.md) to craft.

This Outfit additionally requires the player to be at least [Power](Power.md) 10 and have at least 25 [Intelligence](Intelligence.md) to be crafted.

### _Armor Stats_

This Outfit has 1500 durability and grants +10% Physical resistance ResistanceBlunt ResistanceSlash, +25% Elemental resistance [ResistanceElemental](Attunement.md), +10% Lightning resistance [ResistanceThundercall](Thundercall.md), +10% Ice resistance [ResistanceFrostdraw](Frostdraw.md), and +50% Ether Regen [IconEther](Ether.md). Additionally, it provides the [Devastating Power](Talents.md#devastating-power) Talent.
...
-   Expect to get a minimum of +40 Ether on common builds, with an upper limit of +140 Ether with the [Neuroplasticity](Talents.md#neuroplasticity), [Wisp Convergence](Talents.md#wisp-convergence), [Will o' Wisp](Talents.md#will-o-wisp) Talents, and the [Saintsworn](Saintsworn.md) Oath.
    -   Wisp Convergence will not work if you do not have [Oathless](Oathless.md), but it will still grant its additional Wisp Mantra slot.
