...
2.  After you got the galewax, return to the start and instead of taking the straight path take the path on the right. (BE CAREFUL OF THE WIND, IT CAN BLOW YOU IN THE VOID)
3.  There should be a pillar surrounded by 4 candles and you have to use the 4 galewax on each candle.
4.  Enter the pillar, there are 3 chests, some of them contain layer 2 weapons and one of them could contain an enchantment stone. (It isn't 100% that an enchantment stone will spawn in a chest, however it is very common.)
5.  Escape Layer 2 by killing Chaser so you can keep your enchantment stone and loot.
