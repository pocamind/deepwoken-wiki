...
If you have Ally reputation with [The Ministry](The_Ministry.md), he will hand over the [Deepspindle](Deepspindle.md), a [Deepscorn Casque](Deepscorn_Casque.md) and the [Darkened Bastion](Darkened_Bastion.md) without a fight.
...
| **Critical** | stabs the weapon forward, marking an enemy before dealing damage multiple times. This critical attack uniquely apply true stun, preventing any and all actions while being hit, including venting. | ◯ | ✗ | ◯ | (★★☆) |
| Rising Shadow | User moves their hands outward, creating a black tendril that chases nearby enemies. When connecting
hitting an enemy, they will be lifted into the air and smashed into the ground, dealing damage and stealing ether. This attack can summon multiple tendrils to grab multiple people simultaneously.

 | ◯ | ◯ | ◯ | (★★☆) |
| Revenge | 

-   A quick dash signified by a red-line effect.
-   The move teleports him forwards only upon hitting the player

 | ◯ | ◯ | ◯ | (☆☆☆) |
| Shadow Assault | User performs a wind-up before rushing forward as a shadow orb, hitting anyone in their path while applying darkness. | ◯ | ◯ | ◯ | (★★☆) |
