...
Unlike other dungeons, the Second Layer has two different methods to access it, while more in-depth on the [Second Layer](../Second_Layer.md) page, it can be accessed via either jumping into a void while above 50% Health (75% in Player Combat), or by talking to [Klaris Llfiend, Mother of Lights](../Klaris_Llfiend,_Mother_of_Lights.md) while above Power 15.
