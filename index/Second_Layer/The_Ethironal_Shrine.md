...
# Second Layer/The Ethironal Shrine

LocationL Ethironal Shrine Outskirts LocationR

You awake to a land covered in frost, the wind piercing your ears like the cries of lost souls.
...
Going into the dungeon via Klaris will provide a safe-guard in the form of a [Light-hook](../Light_Hook.md), which will safely eject you back into Layer 1 if you die within the first 20 minutes of entering.

## Objectives

For a visual guide, consider watching _[this video](https://www.youtube.com/watch?v=z0jUO6LiA_8)_.

While navigating the First Floor, there is a clear-set quest-line, which will prove to make subsequent runs easier after the first time done.
...
There are three different methods to escape the second layer, however all of which require pre-requisites.
...
1.  Do Floor 1 as normal.
2.  After killing the Bonekeeper and activating the Generator, instead head to the [Frontier Furnace](../The_Frontier_Furnace.md).
3.  Talk to [Llevyn](../Llevyn.md) in order to activate the Deepdrill.
4.  Escape Firfire Cavern and head into the [Nest Corridor](../Nest_Corridor.md), but instead of going to the exit, go straight into the Deepdrill.
5.  You will have escaped into [The Chariot's Spire](<../The_Chariot's_Spire.md>) and **lost all loot** if you do this method.
...
-   **Warriors Respite** (15FTD): Allows you to heal within the second layer without killing. As campfires/graceful is disabled, this is the only method to passively heal aside from Health Packs (in the latest update, this talent was removed and turned into an innate feature every character has, so you don't need to go out of your way to get this talent anymore.)
...
It is important to note that **very few** good items drop from standard enemy lootpools, and as such it is better to farm the Boss rather than the monsters.
...
3.  Head to Floor 2 and then talk to her at the starting obelisk.
4.  Do Floor 2 as normal, you complete the quest by completing floor 2.
