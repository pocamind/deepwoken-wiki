...
| obtainment | Tome 1, Volu, Tome 2, The Understrand chest, Tome 3, Chaser, Scholar of the Crimson Contract chest |
...
The Strange Tomes are a collection of three books obtained from varying sources. They are required for obtaining the [Bloodfouler](Bloodfouler.md).

The tomes can be obtained from the following, and can be done in any order:
