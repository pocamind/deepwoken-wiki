...
**Effect:** _User creates an Ironsing cube around themselves. Spikes on each of the walls will strike inwards, dealing damage to everyone except for the user._

-   The spikes on each wall attack one at a time.
-   This attack has a very short range and should only be used in close quarters combat.
...
**Effect:** _Perform two quick slashes with your weapon. If Reveal is active, then teleport to nearby targets and slash them._

-   Deals 18.67 Oath & Slash damage twice (37.34 total damage)
-   If Reveal is active, this attack will extend to nearby enemies. Once you teleport to a new enemy, hit them with a significantly weakened Decimate and proc a flurry of slashes. The weakened decimate deals 0.1 damage and the slashes deal 12 damage total (3 slashes that deal 4 damage each).
    -   Deals a total of 49.74 Oath & Slash damage in Reveal (18.67 \* 2 base hits + 0.1 teleport + (4 \* 3 slashes))
